...
public partial class V1beta1LifecycleHookList : IKubernetesObject<V1ListMeta>, IItems<V1beta1LifecycleHook>
{
    ...
    public string Kind { get; set; } = "LifecycleHookList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1LifecycleHook objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1LifecycleHook> Items { get; set; }
}
...
public partial class V1beta1LifecycleHookSpecForProvider
{
    ...
    /// <summary>ARN of the notification target that Auto Scaling will use to notify you when an instance is in the transition state for the lifecycle hook. This ARN target can be either an SQS queue, an SNS topic, or a Lambda function.</summary>
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.5.3+0316f97acf12de380316633df08e7f13a064978d")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1LifecycleHookSpecManagementPoliciesEnum>))]
...
public partial class V1beta1LifecycleHookSpec
{
    ...
    public required V1beta1LifecycleHookSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1LifecycleHook : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1LifecycleHookSpec>, IStatus<V1beta1LifecycleHookStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "LifecycleHook";
    ...
    public required V1beta1LifecycleHookSpec Spec { get; set; }
