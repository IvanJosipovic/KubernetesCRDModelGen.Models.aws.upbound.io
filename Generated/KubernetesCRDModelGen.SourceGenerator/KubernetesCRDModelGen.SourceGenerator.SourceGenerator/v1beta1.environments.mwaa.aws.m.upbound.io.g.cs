...
public partial class V1beta1EnvironmentList : IKubernetesObject<V1ListMeta>, IItems<V1beta1Environment>
{
    ...
    public string ApiVersion { get; set; } = "mwaa.aws.m.upbound.io/v1beta1";
...
public partial class V1beta1EnvironmentSpecForProvider
{
    ...
    /// <summary>Worker replacement strategy. Valid values: FORCED, GRACEFUL.</summary>
    [JsonPropertyName("workerReplacementStrategy")]
