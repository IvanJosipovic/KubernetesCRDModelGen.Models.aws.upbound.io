...
namespace KubernetesCRDModelGen.Models.networkmonitor.aws.upbound.io;
...
public partial class V1beta1MonitorList : IKubernetesObject<V1ListMeta>, IItems<V1beta1Monitor>
{
    ...
    public const string KubeGroup = "networkmonitor.aws.upbound.io";
    public const string KubePluralName = "monitors";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    public string ApiVersion { get; set; } = "networkmonitor.aws.upbound.io/v1beta1";
