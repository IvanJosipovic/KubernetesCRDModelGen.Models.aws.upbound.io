...
public partial class V1beta1APIKeyCredentialProviderList : IKubernetesObject<V1ListMeta>, IItems<V1beta1APIKeyCredentialProvider>
{
    ...
    public const string KubeKind = "APIKeyCredentialProviderList";
    public const string KubeGroup = "bedrockagentcore.aws.upbound.io";
    public const string KubePluralName = "apikeycredentialproviders";
    ...
    public string Kind { get; set; } = "APIKeyCredentialProviderList";
...
public partial class V1beta1APIKeyCredentialProviderSpecProviderConfigRefPolicy
{
    ...
    public V1beta1APIKeyCredentialProviderSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1APIKeyCredentialProviderSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1APIKeyCredentialProviderSpecProviderConfigRef
{
    ...
    public V1beta1APIKeyCredentialProviderSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1APIKeyCredentialProviderSpec
{
    ...
    public V1beta1APIKeyCredentialProviderSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta1APIKeyCredentialProviderSpecForProvider ForProvider { get; set; }
    ...
    public V1beta1APIKeyCredentialProviderSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1APIKeyCredentialProviderSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1APIKeyCredentialProviderSpecProviderConfigRef? ProviderConfigRef { get; set; }
...
public partial class V1beta1APIKeyCredentialProviderStatusAtProvider
{
    ...
    /// <summary>ARN of the API Key credential provider.</summary>
    ...
    /// <summary>Name of the API Key credential provider. Forces replacement when changed.</summary>
    [JsonPropertyName("name")]
...
public partial class V1beta1APIKeyCredentialProviderStatus
{
    ...
    public V1beta1APIKeyCredentialProviderStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1APIKeyCredentialProviderStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "APIKeyCredentialProvider";
    public const string KubeGroup = "bedrockagentcore.aws.upbound.io";
    public const string KubePluralName = "apikeycredentialproviders";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "APIKeyCredentialProvider";
    ...
    public required V1beta1APIKeyCredentialProviderSpec Spec { get; set; }

    /// <summary>APIKeyCredentialProviderStatus defines the observed state of APIKeyCredentialProvider.</summary>
    [JsonPropertyName("status")]
    public V1beta1APIKeyCredentialProviderStatus? Status { get; set; }
}