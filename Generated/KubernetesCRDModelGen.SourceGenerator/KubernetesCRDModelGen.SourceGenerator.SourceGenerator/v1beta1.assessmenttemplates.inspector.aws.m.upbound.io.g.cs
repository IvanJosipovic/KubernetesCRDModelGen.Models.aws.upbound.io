...
public partial class V1beta1AssessmentTemplateList : IKubernetesObject<V1ListMeta>, IItems<V1beta1AssessmentTemplate>
{
    ...
    public string Kind { get; set; } = "AssessmentTemplateList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1AssessmentTemplate objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1AssessmentTemplate> Items { get; set; }
}
...
public partial class V1beta1AssessmentTemplateSpec
{
    ...
    public required V1beta1AssessmentTemplateSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1AssessmentTemplate : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1AssessmentTemplateSpec>, IStatus<V1beta1AssessmentTemplateStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "AssessmentTemplate";
    ...
    public required V1beta1AssessmentTemplateSpec Spec { get; set; }
