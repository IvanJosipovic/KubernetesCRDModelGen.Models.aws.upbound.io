...
public partial class V1beta1DocumentList : IKubernetesObject<V1ListMeta>, IItems<V1beta1Document>
{
    ...
    /// <summary>List of V1beta1Document objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1Document> Items { get; set; }
}
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.0+0fbafdb9fc339df17b265ba23ecc4a7be2359877")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1DocumentSpecManagementPoliciesEnum>))]
...
public partial class V1beta1DocumentSpec
{
    ...
    public required V1beta1DocumentSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1Document : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1DocumentSpec>, IStatus<V1beta1DocumentStatus?>
{
    ...
    public required V1beta1DocumentSpec Spec { get; set; }
