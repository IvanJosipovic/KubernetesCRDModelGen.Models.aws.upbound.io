...
public partial class V1beta1ThingPrincipalAttachmentList : IKubernetesObject<V1ListMeta>, IItems<V1beta1ThingPrincipalAttachment>
{
    ...
    public string Kind { get; set; } = "ThingPrincipalAttachmentList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1ThingPrincipalAttachment objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1ThingPrincipalAttachment> Items { get; set; }
}
...
public partial class V1beta1ThingPrincipalAttachmentSpecForProvider
{
    ...
    /// <summary>The type of relationship to specify when attaching a principal to a thing. Valid values are EXCLUSIVE_THING (the thing will be the only one attached to the principal) or NON_EXCLUSIVE_THING (multiple things can be attached to the principal). Defaults to NON_EXCLUSIVE_THING.</summary>
    [JsonPropertyName("thingPrincipalType")]
...
public partial class V1beta1ThingPrincipalAttachmentSpec
{
    ...
    public required V1beta1ThingPrincipalAttachmentSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1ThingPrincipalAttachment : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1ThingPrincipalAttachmentSpec>, IStatus<V1beta1ThingPrincipalAttachmentStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ThingPrincipalAttachment";
    ...
    public required V1beta1ThingPrincipalAttachmentSpec Spec { get; set; }
