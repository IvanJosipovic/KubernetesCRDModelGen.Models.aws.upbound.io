...
public partial class V1beta1ResourceSpecForProvider
{
    ...
    /// <summary>Boolean to grant the calling principal the permissions to perform all supported Lake Formation operations on the registered data location.</summary>
    [JsonPropertyName("withPrivilegedAccess")]
