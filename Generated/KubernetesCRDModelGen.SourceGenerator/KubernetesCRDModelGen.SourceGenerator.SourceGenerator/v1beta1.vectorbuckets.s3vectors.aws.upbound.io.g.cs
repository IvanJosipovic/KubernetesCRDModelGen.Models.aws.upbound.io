...
public partial class V1beta1VectorBucketList : IKubernetesObject<V1ListMeta>, IItems<V1beta1VectorBucket>
{
    ...
    public const string KubeKind = "VectorBucketList";
    public const string KubeGroup = "s3vectors.aws.upbound.io";
    public const string KubePluralName = "vectorbuckets";
    ...
    public string Kind { get; set; } = "VectorBucketList";
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.5.3+0316f97acf12de380316633df08e7f13a064978d")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1VectorBucketSpecDeletionPolicyEnum>))]
public enum V1beta1VectorBucketSpecDeletionPolicyEnum
{
...
public partial class V1beta1VectorBucketSpecForProviderEncryptionConfigurationKmsKeyArnRefPolicy
{
    ...
    public V1beta1VectorBucketSpecForProviderEncryptionConfigurationKmsKeyArnRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1VectorBucketSpecForProviderEncryptionConfigurationKmsKeyArnRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VectorBucketSpecForProviderEncryptionConfigurationKmsKeyArnRef
{
    ...
    public V1beta1VectorBucketSpecForProviderEncryptionConfigurationKmsKeyArnRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1VectorBucketSpecForProviderEncryptionConfigurationKmsKeyArnSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1VectorBucketSpecForProviderEncryptionConfigurationKmsKeyArnSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1VectorBucketSpecForProviderEncryptionConfigurationKmsKeyArnSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
{
    /// <summary>AWS KMS CMK ARN to use for the default encryption of the vector bucket. Allowed if and only if sse_type is set to aws:kms.</summary>
    [JsonPropertyName("kmsKeyArn")]
    public string? KmsKeyArn { get; set; }

    /// <summary>Reference to a Key in kms to populate kmsKeyArn.</summary>
    [JsonPropertyName("kmsKeyArnRef")]
    public V1beta1VectorBucketSpecForProviderEncryptionConfigurationKmsKeyArnRef? KmsKeyArnRef { get; set; }

    /// <summary>Selector for a Key in kms to populate kmsKeyArn.</summary>
    [JsonPropertyName("kmsKeyArnSelector")]
    public V1beta1VectorBucketSpecForProviderEncryptionConfigurationKmsKeyArnSelector? KmsKeyArnSelector { get; set; }

    /// <summary>Server-side encryption type to use for the default encryption of the vector bucket. Valid values: AES256, aws:kms.</summary>
...
public partial class V1beta1VectorBucketSpecForProvider
{
    ...
    /// <summary>Boolean that indicates all indexes and vectors should be deleted from the vector bucket when the vector bucket is destroyed so that the vector bucket can be destroyed without error. If setting this field in the same operation that would require replacing the vector bucket or destroying the vector bucket, this flag will not work.</summary>
    ...
    /// <summary>Name of the vector bucket.</summary>
...
public partial class V1beta1VectorBucketSpecInitProviderEncryptionConfigurationKmsKeyArnRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1VectorBucketSpecInitProviderEncryptionConfigurationKmsKeyArnRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1VectorBucketSpecInitProviderEncryptionConfigurationKmsKeyArnRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VectorBucketSpecInitProviderEncryptionConfigurationKmsKeyArnRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1VectorBucketSpecInitProviderEncryptionConfigurationKmsKeyArnRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1VectorBucketSpecInitProviderEncryptionConfigurationKmsKeyArnSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1VectorBucketSpecInitProviderEncryptionConfigurationKmsKeyArnSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1VectorBucketSpecInitProviderEncryptionConfigurationKmsKeyArnSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VectorBucketSpecInitProviderEncryptionConfiguration
{
    ...
    /// <summary>Reference to a Key in kms to populate kmsKeyArn.</summary>
    [JsonPropertyName("kmsKeyArnRef")]
    public V1beta1VectorBucketSpecInitProviderEncryptionConfigurationKmsKeyArnRef? KmsKeyArnRef { get; set; }

    /// <summary>Selector for a Key in kms to populate kmsKeyArn.</summary>
    [JsonPropertyName("kmsKeyArnSelector")]
    public V1beta1VectorBucketSpecInitProviderEncryptionConfigurationKmsKeyArnSelector? KmsKeyArnSelector { get; set; }
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.5.3+0316f97acf12de380316633df08e7f13a064978d")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1VectorBucketSpecProviderConfigRefPolicyResolutionEnum>))]
public enum V1beta1VectorBucketSpecProviderConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    Required,
    [EnumMember(Value = "Optional"), JsonStringEnumMemberName("Optional")]
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.5.3+0316f97acf12de380316633df08e7f13a064978d")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1VectorBucketSpecProviderConfigRefPolicyResolveEnum>))]
public enum V1beta1VectorBucketSpecProviderConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    Always,
    [EnumMember(Value = "IfNotPresent"), JsonStringEnumMemberName("IfNotPresent")]
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.5.3+0316f97acf12de380316633df08e7f13a064978d")]
[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1VectorBucketSpecProviderConfigRefPolicy
{
    /// <summary>
    /// Resolution specifies whether resolution of this reference is required.
    /// The default is &apos;Required&apos;, which means the reconcile will fail if the
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1VectorBucketSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1VectorBucketSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VectorBucketSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1VectorBucketSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1VectorBucketSpec
{
    ...
    public V1beta1VectorBucketSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta1VectorBucketSpecForProvider ForProvider { get; set; }
    ...
    public V1beta1VectorBucketSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1VectorBucketSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1VectorBucketSpecProviderConfigRef? ProviderConfigRef { get; set; }
...
{
    /// <summary>Date and time when the vector bucket was created.</summary>
...
public partial class V1beta1VectorBucketStatus
{
    ...
    public V1beta1VectorBucketStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1VectorBucketStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "VectorBucket";
    public const string KubeGroup = "s3vectors.aws.upbound.io";
    public const string KubePluralName = "vectorbuckets";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "VectorBucket";
    ...
    public required V1beta1VectorBucketSpec Spec { get; set; }

    /// <summary>VectorBucketStatus defines the observed state of VectorBucket.</summary>
    [JsonPropertyName("status")]
    public V1beta1VectorBucketStatus? Status { get; set; }
}