...
{
    /// <summary>ARN for this account.</summary>
    ...
    /// <summary>State of the account in the organization.</summary>
    [JsonPropertyName("state")]
    public string? State { get; set; }

    /// <summary>(Deprecated use state instead) Status of the account in the organization.</summary>
