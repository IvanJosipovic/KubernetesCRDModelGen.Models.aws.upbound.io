...
public partial class V1beta1VPCEndpointConnectionAccepterList : IKubernetesObject<V1ListMeta>, IItems<V1beta1VPCEndpointConnectionAccepter>
{
    ...
    public const string KubeKind = "VPCEndpointConnectionAccepterList";
    public const string KubeGroup = "ec2.aws.upbound.io";
    public const string KubePluralName = "vpcendpointconnectionaccepters";
    ...
    public string Kind { get; set; } = "VPCEndpointConnectionAccepterList";
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.5.2+8c7b4a3647c1e77cd3e3152af5701ec2357dafe9")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1VPCEndpointConnectionAccepterSpecDeletionPolicyEnum>))]
public enum V1beta1VPCEndpointConnectionAccepterSpecDeletionPolicyEnum
{
...
public partial class V1beta1VPCEndpointConnectionAccepterSpecForProviderVpcEndpointIdRefPolicy
{
    ...
    public V1beta1VPCEndpointConnectionAccepterSpecForProviderVpcEndpointIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1VPCEndpointConnectionAccepterSpecForProviderVpcEndpointIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VPCEndpointConnectionAccepterSpecForProviderVpcEndpointIdRef
{
    ...
    public V1beta1VPCEndpointConnectionAccepterSpecForProviderVpcEndpointIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1VPCEndpointConnectionAccepterSpecForProviderVpcEndpointIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1VPCEndpointConnectionAccepterSpecForProviderVpcEndpointIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1VPCEndpointConnectionAccepterSpecForProviderVpcEndpointIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VPCEndpointConnectionAccepterSpecForProviderVpcEndpointIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1VPCEndpointConnectionAccepterSpecForProviderVpcEndpointIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1VPCEndpointConnectionAccepterSpecForProviderVpcEndpointServiceIdRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1VPCEndpointConnectionAccepterSpecForProviderVpcEndpointServiceIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1VPCEndpointConnectionAccepterSpecForProviderVpcEndpointServiceIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VPCEndpointConnectionAccepterSpecForProviderVpcEndpointServiceIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1VPCEndpointConnectionAccepterSpecForProviderVpcEndpointServiceIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1VPCEndpointConnectionAccepterSpecForProviderVpcEndpointServiceIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1VPCEndpointConnectionAccepterSpecForProviderVpcEndpointServiceIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1VPCEndpointConnectionAccepterSpecForProviderVpcEndpointServiceIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VPCEndpointConnectionAccepterSpecForProvider
{
    ...
    /// <summary>AWS VPC Endpoint ID.</summary>
    [JsonPropertyName("vpcEndpointId")]
    public string? VpcEndpointId { get; set; }

    /// <summary>Reference to a VPCEndpoint in ec2 to populate vpcEndpointId.</summary>
    [JsonPropertyName("vpcEndpointIdRef")]
    public V1beta1VPCEndpointConnectionAccepterSpecForProviderVpcEndpointIdRef? VpcEndpointIdRef { get; set; }

    /// <summary>Selector for a VPCEndpoint in ec2 to populate vpcEndpointId.</summary>
    [JsonPropertyName("vpcEndpointIdSelector")]
    public V1beta1VPCEndpointConnectionAccepterSpecForProviderVpcEndpointIdSelector? VpcEndpointIdSelector { get; set; }

    /// <summary>AWS VPC Endpoint Service ID.</summary>
    [JsonPropertyName("vpcEndpointServiceId")]
    public string? VpcEndpointServiceId { get; set; }

    /// <summary>Reference to a VPCEndpointService in ec2 to populate vpcEndpointServiceId.</summary>
    [JsonPropertyName("vpcEndpointServiceIdRef")]
    public V1beta1VPCEndpointConnectionAccepterSpecForProviderVpcEndpointServiceIdRef? VpcEndpointServiceIdRef { get; set; }

    /// <summary>Selector for a VPCEndpointService in ec2 to populate vpcEndpointServiceId.</summary>
    [JsonPropertyName("vpcEndpointServiceIdSelector")]
    public V1beta1VPCEndpointConnectionAccepterSpecForProviderVpcEndpointServiceIdSelector? VpcEndpointServiceIdSelector { get; set; }
}
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.5.2+8c7b4a3647c1e77cd3e3152af5701ec2357dafe9")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1VPCEndpointConnectionAccepterSpecProviderConfigRefPolicyResolutionEnum>))]
public enum V1beta1VPCEndpointConnectionAccepterSpecProviderConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    Required,
    [EnumMember(Value = "Optional"), JsonStringEnumMemberName("Optional")]
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.5.2+8c7b4a3647c1e77cd3e3152af5701ec2357dafe9")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1VPCEndpointConnectionAccepterSpecProviderConfigRefPolicyResolveEnum>))]
public enum V1beta1VPCEndpointConnectionAccepterSpecProviderConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    Always,
    [EnumMember(Value = "IfNotPresent"), JsonStringEnumMemberName("IfNotPresent")]
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.5.2+8c7b4a3647c1e77cd3e3152af5701ec2357dafe9")]
[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1VPCEndpointConnectionAccepterSpecProviderConfigRefPolicy
{
    /// <summary>
    /// Resolution specifies whether resolution of this reference is required.
    /// The default is &apos;Required&apos;, which means the reconcile will fail if the
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1VPCEndpointConnectionAccepterSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1VPCEndpointConnectionAccepterSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VPCEndpointConnectionAccepterSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1VPCEndpointConnectionAccepterSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1VPCEndpointConnectionAccepterSpec
{
    ...
    public V1beta1VPCEndpointConnectionAccepterSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta1VPCEndpointConnectionAccepterSpecForProvider ForProvider { get; set; }
    ...
    public V1beta1VPCEndpointConnectionAccepterSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1VPCEndpointConnectionAccepterSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1VPCEndpointConnectionAccepterSpecProviderConfigRef? ProviderConfigRef { get; set; }
...
{
    /// <summary>The ID of the VPC Endpoint Connection.</summary>
    [JsonPropertyName("id")]
    ...
    /// <summary>State of the VPC Endpoint.</summary>
    [JsonPropertyName("vpcEndpointState")]
    public string? VpcEndpointState { get; set; }
}
...
public partial class V1beta1VPCEndpointConnectionAccepterStatus
{
    ...
    public V1beta1VPCEndpointConnectionAccepterStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1VPCEndpointConnectionAccepterStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "VPCEndpointConnectionAccepter";
    public const string KubeGroup = "ec2.aws.upbound.io";
    public const string KubePluralName = "vpcendpointconnectionaccepters";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "VPCEndpointConnectionAccepter";
    ...
    public required V1beta1VPCEndpointConnectionAccepterSpec Spec { get; set; }

    /// <summary>VPCEndpointConnectionAccepterStatus defines the observed state of VPCEndpointConnectionAccepter.</summary>
    [JsonPropertyName("status")]
    public V1beta1VPCEndpointConnectionAccepterStatus? Status { get; set; }
}