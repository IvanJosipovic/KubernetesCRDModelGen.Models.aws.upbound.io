...
public partial class V1beta1DomainList : IKubernetesObject<V1ListMeta>, IItems<V1beta1Domain>
{
    ...
    public string ApiVersion { get; set; } = "elasticsearch.aws.m.upbound.io/v1beta1";
...
public partial class V1beta1DomainSpecForProviderVpcOptionsSecurityGroupIdsRefsPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1DomainSpecForProviderVpcOptionsSecurityGroupIdsRefsPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1DomainSpecForProviderVpcOptionsSecurityGroupIdsRefsPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1DomainSpecForProviderVpcOptionsSecurityGroupIdsSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1DomainSpecForProviderVpcOptionsSecurityGroupIdsSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1DomainSpecForProviderVpcOptionsSecurityGroupIdsSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1DomainSpecInitProviderVpcOptionsSecurityGroupIdsRefsPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1DomainSpecInitProviderVpcOptionsSecurityGroupIdsRefsPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1DomainSpecInitProviderVpcOptionsSecurityGroupIdsRefsPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1DomainSpecInitProviderVpcOptionsSecurityGroupIdsSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1DomainSpecInitProviderVpcOptionsSecurityGroupIdsSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1DomainSpecInitProviderVpcOptionsSecurityGroupIdsSelectorPolicyResolveEnum? Resolve { get; set; }
}
