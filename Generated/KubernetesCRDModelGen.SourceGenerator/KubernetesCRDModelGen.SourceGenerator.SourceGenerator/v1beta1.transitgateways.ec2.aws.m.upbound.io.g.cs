...
public partial class V1beta1TransitGatewayList : IKubernetesObject<V1ListMeta>, IItems<V1beta1TransitGateway>
{
    ...
    public string Kind { get; set; } = "TransitGatewayList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1TransitGateway objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1TransitGateway> Items { get; set; }
}
...
public partial class V1beta1TransitGatewaySpecForProvider
{
    ...
    /// <summary>Whether encryption support for VPC Encryption Control is enabled. Valid values: disable, enable. Default value: disable. Once set, switching to disable requires explicitly specifying disable rather than removing the argument.</summary>
    [JsonPropertyName("encryptionSupport")]
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.0+0fbafdb9fc339df17b265ba23ecc4a7be2359877")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1TransitGatewaySpecManagementPoliciesEnum>))]
...
public partial class V1beta1TransitGatewaySpec
{
    ...
    public required V1beta1TransitGatewaySpecForProvider ForProvider { get; set; }
...
public partial class V1beta1TransitGateway : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1TransitGatewaySpec>, IStatus<V1beta1TransitGatewayStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "TransitGateway";
    ...
    public required V1beta1TransitGatewaySpec Spec { get; set; }
