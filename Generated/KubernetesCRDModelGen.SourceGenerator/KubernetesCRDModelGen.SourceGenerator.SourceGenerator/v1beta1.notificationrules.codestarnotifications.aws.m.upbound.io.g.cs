...
public partial class V1beta1NotificationRuleList : IKubernetesObject<V1ListMeta>, IItems<V1beta1NotificationRule>
{
    ...
    public string ApiVersion { get; set; } = "codestarnotifications.aws.m.upbound.io/v1beta1";

    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "NotificationRuleList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1NotificationRule objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1NotificationRule> Items { get; set; }
}
...
{
    /// <summary>The ARN of the Amazon Q Developer in chat applications topic or Amazon Q Developer in chat applications client.</summary>
    ...
    /// <summary>The type of the notification target. Valid values are SNS, AWSChatbotSlack, and AWSChatbotMicrosoftTeams. Default value is SNS.</summary>
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.5.3+0316f97acf12de380316633df08e7f13a064978d")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1NotificationRuleSpecManagementPoliciesEnum>))]
...
public partial class V1beta1NotificationRuleSpec
{
    ...
    public required V1beta1NotificationRuleSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1NotificationRule : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1NotificationRuleSpec>, IStatus<V1beta1NotificationRuleStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "NotificationRule";
    ...
    public required V1beta1NotificationRuleSpec Spec { get; set; }
