...
public partial class V1beta1TokenVaultCmkList : IKubernetesObject<V1ListMeta>, IItems<V1beta1TokenVaultCmk>
{
    ...
    public const string KubeKind = "TokenVaultCmkList";
    public const string KubeGroup = "bedrockagentcore.aws.upbound.io";
    public const string KubePluralName = "tokenvaultcmks";
    ...
    public string Kind { get; set; } = "TokenVaultCmkList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1TokenVaultCmk objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1TokenVaultCmk> Items { get; set; }
}
...
public partial class V1beta1TokenVaultCmkSpecForProviderKmsConfigurationKmsKeyArnRefPolicy
{
    ...
    public V1beta1TokenVaultCmkSpecForProviderKmsConfigurationKmsKeyArnRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1TokenVaultCmkSpecForProviderKmsConfigurationKmsKeyArnRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1TokenVaultCmkSpecForProviderKmsConfigurationKmsKeyArnRef
{
    ...
    public V1beta1TokenVaultCmkSpecForProviderKmsConfigurationKmsKeyArnRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1TokenVaultCmkSpecForProviderKmsConfigurationKmsKeyArnSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1TokenVaultCmkSpecForProviderKmsConfigurationKmsKeyArnSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1TokenVaultCmkSpecForProviderKmsConfigurationKmsKeyArnSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1TokenVaultCmkSpecForProviderKmsConfigurationKmsKeyArnSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1TokenVaultCmkSpecForProviderKmsConfigurationKmsKeyArnSelectorPolicy? Policy { get; set; }
}
...
{
    /// <summary>Type of KMS key. Valid values: CustomerManagedKey, ServiceManagedKey.</summary>
    ...
    public V1beta1TokenVaultCmkSpecForProviderKmsConfigurationKmsKeyArnRef? KmsKeyArnRef { get; set; }
...
{
    /// <summary>KMS configuration for the token vault. See kms_configuration below.</summary>
    [JsonPropertyName("kmsConfiguration")]
    public V1beta1TokenVaultCmkSpecForProviderKmsConfiguration? KmsConfiguration { get; set; }
    ...
    /// <summary>Token vault ID. Defaults to default.</summary>
    [JsonPropertyName("tokenVaultId")]
...
public partial class V1beta1TokenVaultCmkSpecInitProviderKmsConfigurationKmsKeyArnRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1TokenVaultCmkSpecInitProviderKmsConfigurationKmsKeyArnRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1TokenVaultCmkSpecInitProviderKmsConfigurationKmsKeyArnRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1TokenVaultCmkSpecInitProviderKmsConfigurationKmsKeyArnRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1TokenVaultCmkSpecInitProviderKmsConfigurationKmsKeyArnRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1TokenVaultCmkSpecInitProviderKmsConfigurationKmsKeyArnSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1TokenVaultCmkSpecInitProviderKmsConfigurationKmsKeyArnSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1TokenVaultCmkSpecInitProviderKmsConfigurationKmsKeyArnSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1TokenVaultCmkSpecInitProviderKmsConfigurationKmsKeyArnSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1TokenVaultCmkSpecInitProviderKmsConfigurationKmsKeyArnSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1TokenVaultCmkSpecInitProviderKmsConfiguration
{
    ...
    /// <summary>Reference to a Key in kms to populate kmsKeyArn.</summary>
    [JsonPropertyName("kmsKeyArnRef")]
    public V1beta1TokenVaultCmkSpecInitProviderKmsConfigurationKmsKeyArnRef? KmsKeyArnRef { get; set; }

    /// <summary>Selector for a Key in kms to populate kmsKeyArn.</summary>
    [JsonPropertyName("kmsKeyArnSelector")]
    public V1beta1TokenVaultCmkSpecInitProviderKmsConfigurationKmsKeyArnSelector? KmsKeyArnSelector { get; set; }
}
...
public partial class V1beta1TokenVaultCmkSpecInitProvider
{
    /// <summary>KMS configuration for the token vault. See kms_configuration below.</summary>
    [JsonPropertyName("kmsConfiguration")]
    public V1beta1TokenVaultCmkSpecInitProviderKmsConfiguration? KmsConfiguration { get; set; }
}
...
public partial class V1beta1TokenVaultCmkSpecProviderConfigRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1TokenVaultCmkSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1TokenVaultCmkSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1TokenVaultCmkSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1TokenVaultCmkSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1TokenVaultCmkSpec
{
    ...
    public V1beta1TokenVaultCmkSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta1TokenVaultCmkSpecForProvider ForProvider { get; set; }
    ...
    public V1beta1TokenVaultCmkSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1TokenVaultCmkSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1TokenVaultCmkSpecProviderConfigRef? ProviderConfigRef { get; set; }
    ...
    public V1beta1TokenVaultCmkSpecWriteConnectionSecretToRef? WriteConnectionSecretToRef { get; set; }
}
...
public partial class V1beta1TokenVaultCmkStatusAtProvider
{
    ...
    /// <summary>KMS configuration for the token vault. See kms_configuration below.</summary>
    [JsonPropertyName("kmsConfiguration")]
    public V1beta1TokenVaultCmkStatusAtProviderKmsConfiguration? KmsConfiguration { get; set; }
...
public partial class V1beta1TokenVaultCmkStatus
{
    ...
    public V1beta1TokenVaultCmkStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1TokenVaultCmkStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "TokenVaultCmk";
    public const string KubeGroup = "bedrockagentcore.aws.upbound.io";
    public const string KubePluralName = "tokenvaultcmks";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "TokenVaultCmk";
    ...
    public required V1beta1TokenVaultCmkSpec Spec { get; set; }

    /// <summary>TokenVaultCmkStatus defines the observed state of TokenVaultCmk.</summary>
    [JsonPropertyName("status")]
    public V1beta1TokenVaultCmkStatus? Status { get; set; }
}