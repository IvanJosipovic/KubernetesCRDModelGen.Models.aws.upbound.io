...
public partial class V1beta1VPCIPv6CidrBlockAssociationList : IKubernetesObject<V1ListMeta>, IItems<V1beta1VPCIPv6CidrBlockAssociation>
{
    ...
    public const string KubeKind = "VPCIPv6CidrBlockAssociationList";
    public const string KubeGroup = "ec2.aws.upbound.io";
    public const string KubePluralName = "vpcipv6cidrblockassociations";
    ...
    public string Kind { get; set; } = "VPCIPv6CidrBlockAssociationList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1VPCIPv6CidrBlockAssociation objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1VPCIPv6CidrBlockAssociation> Items { get; set; }
}
...
public partial class V1beta1VPCIPv6CidrBlockAssociationSpecForProviderIpv6IpamPoolIdRefPolicy
{
    ...
    public V1beta1VPCIPv6CidrBlockAssociationSpecForProviderIpv6IpamPoolIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1VPCIPv6CidrBlockAssociationSpecForProviderIpv6IpamPoolIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VPCIPv6CidrBlockAssociationSpecForProviderIpv6IpamPoolIdRef
{
    ...
    public V1beta1VPCIPv6CidrBlockAssociationSpecForProviderIpv6IpamPoolIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1VPCIPv6CidrBlockAssociationSpecForProviderIpv6IpamPoolIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1VPCIPv6CidrBlockAssociationSpecForProviderIpv6IpamPoolIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1VPCIPv6CidrBlockAssociationSpecForProviderIpv6IpamPoolIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VPCIPv6CidrBlockAssociationSpecForProviderIpv6IpamPoolIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1VPCIPv6CidrBlockAssociationSpecForProviderIpv6IpamPoolIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1VPCIPv6CidrBlockAssociationSpecForProviderVpcIdRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1VPCIPv6CidrBlockAssociationSpecForProviderVpcIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1VPCIPv6CidrBlockAssociationSpecForProviderVpcIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VPCIPv6CidrBlockAssociationSpecForProviderVpcIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1VPCIPv6CidrBlockAssociationSpecForProviderVpcIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1VPCIPv6CidrBlockAssociationSpecForProviderVpcIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1VPCIPv6CidrBlockAssociationSpecForProviderVpcIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1VPCIPv6CidrBlockAssociationSpecForProviderVpcIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
{
    /// <summary>Requests an Amazon-provided IPv6 CIDR block with a /56 prefix length for the VPC. You cannot specify the range of IPv6 addresses, or the size of the CIDR block. Default is false. Conflicts with ipv6_ipam_pool_id, ipv6_pool, ipv6_cidr_block and ipv6_netmask_length.</summary>
    [JsonPropertyName("assignGeneratedIpv6CidrBlock")]
    public bool? AssignGeneratedIpv6CidrBlock { get; set; }

    /// <summary>The IPv6 CIDR block for the VPC. CIDR can be explicitly set or it can be derived from IPAM using ipv6_netmask_length. This parameter is required if ipv6_netmask_length is not set and the IPAM pool does not have allocation_default_netmask set. Conflicts with assign_generated_ipv6_cidr_block.</summary>
    [JsonPropertyName("ipv6CidrBlock")]
    public string? Ipv6CidrBlock { get; set; }

    /// <summary>The ID of an IPv6 IPAM pool you want to use for allocating this VPC&apos;s CIDR. IPAM is a VPC feature that you can use to automate your IP address management workflows including assigning, tracking, troubleshooting, and auditing IP addresses across AWS Regions and accounts. Conflict with assign_generated_ipv6_cidr_block and ipv6_pool.</summary>
    [JsonPropertyName("ipv6IpamPoolId")]
    public string? Ipv6IpamPoolId { get; set; }

    /// <summary>Reference to a VPCIpamPool in ec2 to populate ipv6IpamPoolId.</summary>
    [JsonPropertyName("ipv6IpamPoolIdRef")]
    public V1beta1VPCIPv6CidrBlockAssociationSpecForProviderIpv6IpamPoolIdRef? Ipv6IpamPoolIdRef { get; set; }

    /// <summary>Selector for a VPCIpamPool in ec2 to populate ipv6IpamPoolId.</summary>
    [JsonPropertyName("ipv6IpamPoolIdSelector")]
    public V1beta1VPCIPv6CidrBlockAssociationSpecForProviderIpv6IpamPoolIdSelector? Ipv6IpamPoolIdSelector { get; set; }

    /// <summary>The netmask length of the IPv6 CIDR you want to allocate to this VPC. Requires specifying a ipv6_ipam_pool_id. This parameter is optional if the IPAM pool has allocation_default_netmask set, otherwise it or ipv6_cidr_block are required. Conflicts with ipv6_cidr_block.</summary>
    [JsonPropertyName("ipv6NetmaskLength")]
    public double? Ipv6NetmaskLength { get; set; }

    /// <summary>The  ID of an IPv6 address pool from which to allocate the IPv6 CIDR block. Conflicts with assign_generated_ipv6_cidr_block and ipv6_ipam_pool_id.</summary>
    ...
    public V1beta1VPCIPv6CidrBlockAssociationSpecForProviderVpcIdRef? VpcIdRef { get; set; }

    /// <summary>Selector for a VPC in ec2 to populate vpcId.</summary>
    [JsonPropertyName("vpcIdSelector")]
    public V1beta1VPCIPv6CidrBlockAssociationSpecForProviderVpcIdSelector? VpcIdSelector { get; set; }
}
...
public partial class V1beta1VPCIPv6CidrBlockAssociationSpecInitProviderIpv6IpamPoolIdRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1VPCIPv6CidrBlockAssociationSpecInitProviderIpv6IpamPoolIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1VPCIPv6CidrBlockAssociationSpecInitProviderIpv6IpamPoolIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VPCIPv6CidrBlockAssociationSpecInitProviderIpv6IpamPoolIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1VPCIPv6CidrBlockAssociationSpecInitProviderIpv6IpamPoolIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1VPCIPv6CidrBlockAssociationSpecInitProviderIpv6IpamPoolIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1VPCIPv6CidrBlockAssociationSpecInitProviderIpv6IpamPoolIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1VPCIPv6CidrBlockAssociationSpecInitProviderIpv6IpamPoolIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VPCIPv6CidrBlockAssociationSpecInitProviderIpv6IpamPoolIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1VPCIPv6CidrBlockAssociationSpecInitProviderIpv6IpamPoolIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1VPCIPv6CidrBlockAssociationSpecInitProviderVpcIdRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1VPCIPv6CidrBlockAssociationSpecInitProviderVpcIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1VPCIPv6CidrBlockAssociationSpecInitProviderVpcIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VPCIPv6CidrBlockAssociationSpecInitProviderVpcIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1VPCIPv6CidrBlockAssociationSpecInitProviderVpcIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1VPCIPv6CidrBlockAssociationSpecInitProviderVpcIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1VPCIPv6CidrBlockAssociationSpecInitProviderVpcIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1VPCIPv6CidrBlockAssociationSpecInitProviderVpcIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VPCIPv6CidrBlockAssociationSpecInitProviderVpcIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1VPCIPv6CidrBlockAssociationSpecInitProviderVpcIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1VPCIPv6CidrBlockAssociationSpecInitProvider
{
    ...
    /// <summary>Reference to a VPCIpamPool in ec2 to populate ipv6IpamPoolId.</summary>
    [JsonPropertyName("ipv6IpamPoolIdRef")]
    public V1beta1VPCIPv6CidrBlockAssociationSpecInitProviderIpv6IpamPoolIdRef? Ipv6IpamPoolIdRef { get; set; }

    /// <summary>Selector for a VPCIpamPool in ec2 to populate ipv6IpamPoolId.</summary>
    [JsonPropertyName("ipv6IpamPoolIdSelector")]
    public V1beta1VPCIPv6CidrBlockAssociationSpecInitProviderIpv6IpamPoolIdSelector? Ipv6IpamPoolIdSelector { get; set; }
    ...
    /// <summary>Reference to a VPC in ec2 to populate vpcId.</summary>
    [JsonPropertyName("vpcIdRef")]
    public V1beta1VPCIPv6CidrBlockAssociationSpecInitProviderVpcIdRef? VpcIdRef { get; set; }

    /// <summary>Selector for a VPC in ec2 to populate vpcId.</summary>
    [JsonPropertyName("vpcIdSelector")]
    public V1beta1VPCIPv6CidrBlockAssociationSpecInitProviderVpcIdSelector? VpcIdSelector { get; set; }
}
...
public partial class V1beta1VPCIPv6CidrBlockAssociationSpecProviderConfigRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1VPCIPv6CidrBlockAssociationSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1VPCIPv6CidrBlockAssociationSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VPCIPv6CidrBlockAssociationSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1VPCIPv6CidrBlockAssociationSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1VPCIPv6CidrBlockAssociationSpec
{
    ...
    public V1beta1VPCIPv6CidrBlockAssociationSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta1VPCIPv6CidrBlockAssociationSpecForProvider ForProvider { get; set; }
    ...
    public V1beta1VPCIPv6CidrBlockAssociationSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1VPCIPv6CidrBlockAssociationSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1VPCIPv6CidrBlockAssociationSpecProviderConfigRef? ProviderConfigRef { get; set; }
...
public partial class V1beta1VPCIPv6CidrBlockAssociationStatusAtProvider
{
    ...
    /// <summary>The source that allocated the IP address space. Values: amazon, byoip, none.</summary>
    [JsonPropertyName("ipSource")]
    public string? IpSource { get; set; }

    /// <summary>Public IPv6 addresses are those advertised on the internet from AWS. Private IP addresses are not and cannot be advertised on the internet from AWS. Values: public, private.</summary>
    [JsonPropertyName("ipv6AddressAttribute")]
    public string? Ipv6AddressAttribute { get; set; }
...
public partial class V1beta1VPCIPv6CidrBlockAssociationStatus
{
    ...
    public V1beta1VPCIPv6CidrBlockAssociationStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1VPCIPv6CidrBlockAssociationStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "VPCIPv6CidrBlockAssociation";
    public const string KubeGroup = "ec2.aws.upbound.io";
    public const string KubePluralName = "vpcipv6cidrblockassociations";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "VPCIPv6CidrBlockAssociation";
    ...
    public required V1beta1VPCIPv6CidrBlockAssociationSpec Spec { get; set; }

    /// <summary>VPCIPv6CidrBlockAssociationStatus defines the observed state of VPCIPv6CidrBlockAssociation.</summary>
    [JsonPropertyName("status")]
    public V1beta1VPCIPv6CidrBlockAssociationStatus? Status { get; set; }
}