...
public partial class V1beta1ClusterRoleAssociationList : IKubernetesObject<V1ListMeta>, IItems<V1beta1ClusterRoleAssociation>
{
    ...
    public string Kind { get; set; } = "ClusterRoleAssociationList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1ClusterRoleAssociation objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1ClusterRoleAssociation> Items { get; set; }
}
...
public partial class V1beta1ClusterRoleAssociationSpec
{
    ...
    public required V1beta1ClusterRoleAssociationSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1ClusterRoleAssociation : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1ClusterRoleAssociationSpec>, IStatus<V1beta1ClusterRoleAssociationStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ClusterRoleAssociation";
    ...
    public required V1beta1ClusterRoleAssociationSpec Spec { get; set; }
