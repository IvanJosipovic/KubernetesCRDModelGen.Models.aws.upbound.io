...
public partial class V1beta1KinesisStreamingDestinationList : IKubernetesObject<V1ListMeta>, IItems<V1beta1KinesisStreamingDestination>
{
    ...
    public string Kind { get; set; } = "KinesisStreamingDestinationList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1KinesisStreamingDestination objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1KinesisStreamingDestination> Items { get; set; }
}
...
public partial class V1beta1KinesisStreamingDestinationSpec
{
    ...
    public required V1beta1KinesisStreamingDestinationSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1KinesisStreamingDestination : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1KinesisStreamingDestinationSpec>, IStatus<V1beta1KinesisStreamingDestinationStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "KinesisStreamingDestination";
    ...
    public required V1beta1KinesisStreamingDestinationSpec Spec { get; set; }
