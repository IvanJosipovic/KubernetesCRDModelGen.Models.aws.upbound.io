...
public partial class V1beta1MemoryStrategyList : IKubernetesObject<V1ListMeta>, IItems<V1beta1MemoryStrategy>
{
    ...
    public IList<V1beta1MemoryStrategy>? Items { get; set; }
}
...
public partial class V1beta1MemoryStrategySpecProviderConfigRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1MemoryStrategySpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1MemoryStrategySpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1MemoryStrategySpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1MemoryStrategySpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1MemoryStrategySpec
{
    ...
    public V1beta1MemoryStrategySpecDeletionPolicyEnum? DeletionPolicy { get; set; }
