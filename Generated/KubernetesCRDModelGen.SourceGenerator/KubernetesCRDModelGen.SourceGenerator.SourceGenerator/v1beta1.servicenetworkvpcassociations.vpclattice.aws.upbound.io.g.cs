...
public partial class V1beta1ServiceNetworkVPCAssociationList : IKubernetesObject<V1ListMeta>, IItems<V1beta1ServiceNetworkVPCAssociation>
{
    ...
    public const string KubeKind = "ServiceNetworkVPCAssociationList";
    public const string KubeGroup = "vpclattice.aws.upbound.io";
    public const string KubePluralName = "servicenetworkvpcassociations";
    ...
    public string Kind { get; set; } = "ServiceNetworkVPCAssociationList";
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.0+0fbafdb9fc339df17b265ba23ecc4a7be2359877")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1ServiceNetworkVPCAssociationSpecDeletionPolicyEnum>))]
public enum V1beta1ServiceNetworkVPCAssociationSpecDeletionPolicyEnum
{
...
{
    /// <summary>Preference for which private domains have a private hosted zone created for and associated with the specified VPC. Only supported when private_dns_enabled is true. Valid Values are VERIFIED_DOMAINS_ONLY, ALL_DOMAINS, VERIFIED_DOMAINS_AND_SPECIFIED_DOMAINS and SPECIFIED_DOMAINS_ONLY.</summary>
    [JsonPropertyName("privateDnsPreference")]
    public string? PrivateDnsPreference { get; set; }

    /// <summary>Private domains to create private hosted zones for and associate with the specified VPC. Only supported when private_dns_enabled is true and private_dns_preference is VERIFIED_DOMAINS_AND_SPECIFIED_DOMAINS or SPECIFIED_DOMAINS_ONLY.</summary>
...
public partial class V1beta1ServiceNetworkVPCAssociationSpecForProviderSecurityGroupIdRefsPolicy
{
    ...
    public V1beta1ServiceNetworkVPCAssociationSpecForProviderSecurityGroupIdRefsPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1ServiceNetworkVPCAssociationSpecForProviderSecurityGroupIdRefsPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ServiceNetworkVPCAssociationSpecForProviderSecurityGroupIdRefs
{
    ...
    public V1beta1ServiceNetworkVPCAssociationSpecForProviderSecurityGroupIdRefsPolicy? Policy { get; set; }
}
...
public partial class V1beta1ServiceNetworkVPCAssociationSpecForProviderSecurityGroupIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1ServiceNetworkVPCAssociationSpecForProviderSecurityGroupIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1ServiceNetworkVPCAssociationSpecForProviderSecurityGroupIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ServiceNetworkVPCAssociationSpecForProviderSecurityGroupIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1ServiceNetworkVPCAssociationSpecForProviderSecurityGroupIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1ServiceNetworkVPCAssociationSpecForProviderServiceNetworkIdentifierRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1ServiceNetworkVPCAssociationSpecForProviderServiceNetworkIdentifierRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1ServiceNetworkVPCAssociationSpecForProviderServiceNetworkIdentifierRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ServiceNetworkVPCAssociationSpecForProviderServiceNetworkIdentifierRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1ServiceNetworkVPCAssociationSpecForProviderServiceNetworkIdentifierRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1ServiceNetworkVPCAssociationSpecForProviderServiceNetworkIdentifierSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1ServiceNetworkVPCAssociationSpecForProviderServiceNetworkIdentifierSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1ServiceNetworkVPCAssociationSpecForProviderServiceNetworkIdentifierSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ServiceNetworkVPCAssociationSpecForProviderServiceNetworkIdentifierSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1ServiceNetworkVPCAssociationSpecForProviderServiceNetworkIdentifierSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1ServiceNetworkVPCAssociationSpecForProviderVpcIdentifierRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1ServiceNetworkVPCAssociationSpecForProviderVpcIdentifierRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1ServiceNetworkVPCAssociationSpecForProviderVpcIdentifierRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ServiceNetworkVPCAssociationSpecForProviderVpcIdentifierRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1ServiceNetworkVPCAssociationSpecForProviderVpcIdentifierRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1ServiceNetworkVPCAssociationSpecForProviderVpcIdentifierSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1ServiceNetworkVPCAssociationSpecForProviderVpcIdentifierSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1ServiceNetworkVPCAssociationSpecForProviderVpcIdentifierSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ServiceNetworkVPCAssociationSpecForProvider
{
    ...
    public V1beta1ServiceNetworkVPCAssociationSpecForProviderDnsOptions? DnsOptions { get; set; }

    /// <summary>Boolean to indicate whether to enable private DNS for the VPC association. Defaults to false.</summary>
    ...
    public IList<V1beta1ServiceNetworkVPCAssociationSpecForProviderSecurityGroupIdRefs>? SecurityGroupIdRefs { get; set; }
    ...
    public V1beta1ServiceNetworkVPCAssociationSpecForProviderServiceNetworkIdentifierRef? ServiceNetworkIdentifierRef { get; set; }

    /// <summary>Selector for a ServiceNetwork in vpclattice to populate serviceNetworkIdentifier.</summary>
    [JsonPropertyName("serviceNetworkIdentifierSelector")]
    public V1beta1ServiceNetworkVPCAssociationSpecForProviderServiceNetworkIdentifierSelector? ServiceNetworkIdentifierSelector { get; set; }
    ...
    public V1beta1ServiceNetworkVPCAssociationSpecForProviderVpcIdentifierRef? VpcIdentifierRef { get; set; }

    /// <summary>Selector for a VPC in ec2 to populate vpcIdentifier.</summary>
    [JsonPropertyName("vpcIdentifierSelector")]
    public V1beta1ServiceNetworkVPCAssociationSpecForProviderVpcIdentifierSelector? VpcIdentifierSelector { get; set; }
}
...
public partial class V1beta1ServiceNetworkVPCAssociationSpecInitProviderSecurityGroupIdRefsPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1ServiceNetworkVPCAssociationSpecInitProviderSecurityGroupIdRefsPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1ServiceNetworkVPCAssociationSpecInitProviderSecurityGroupIdRefsPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ServiceNetworkVPCAssociationSpecInitProviderSecurityGroupIdRefs
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1ServiceNetworkVPCAssociationSpecInitProviderSecurityGroupIdRefsPolicy? Policy { get; set; }
}
...
public partial class V1beta1ServiceNetworkVPCAssociationSpecInitProviderSecurityGroupIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1ServiceNetworkVPCAssociationSpecInitProviderSecurityGroupIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1ServiceNetworkVPCAssociationSpecInitProviderSecurityGroupIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ServiceNetworkVPCAssociationSpecInitProviderSecurityGroupIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1ServiceNetworkVPCAssociationSpecInitProviderSecurityGroupIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1ServiceNetworkVPCAssociationSpecInitProviderServiceNetworkIdentifierRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1ServiceNetworkVPCAssociationSpecInitProviderServiceNetworkIdentifierRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1ServiceNetworkVPCAssociationSpecInitProviderServiceNetworkIdentifierRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ServiceNetworkVPCAssociationSpecInitProviderServiceNetworkIdentifierRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1ServiceNetworkVPCAssociationSpecInitProviderServiceNetworkIdentifierRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1ServiceNetworkVPCAssociationSpecInitProviderServiceNetworkIdentifierSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1ServiceNetworkVPCAssociationSpecInitProviderServiceNetworkIdentifierSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1ServiceNetworkVPCAssociationSpecInitProviderServiceNetworkIdentifierSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ServiceNetworkVPCAssociationSpecInitProviderServiceNetworkIdentifierSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1ServiceNetworkVPCAssociationSpecInitProviderServiceNetworkIdentifierSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1ServiceNetworkVPCAssociationSpecInitProviderVpcIdentifierRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1ServiceNetworkVPCAssociationSpecInitProviderVpcIdentifierRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1ServiceNetworkVPCAssociationSpecInitProviderVpcIdentifierRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ServiceNetworkVPCAssociationSpecInitProviderVpcIdentifierRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1ServiceNetworkVPCAssociationSpecInitProviderVpcIdentifierRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1ServiceNetworkVPCAssociationSpecInitProviderVpcIdentifierSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1ServiceNetworkVPCAssociationSpecInitProviderVpcIdentifierSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1ServiceNetworkVPCAssociationSpecInitProviderVpcIdentifierSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ServiceNetworkVPCAssociationSpecInitProviderVpcIdentifierSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1ServiceNetworkVPCAssociationSpecInitProviderVpcIdentifierSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1ServiceNetworkVPCAssociationSpecInitProvider
{
    /// <summary>Configuration block for DNS option. See dns_options block below for details.</summary>
    [JsonPropertyName("dnsOptions")]
    public V1beta1ServiceNetworkVPCAssociationSpecInitProviderDnsOptions? DnsOptions { get; set; }
    ...
    /// <summary>References to SecurityGroup in ec2 to populate securityGroupIds.</summary>
    [JsonPropertyName("securityGroupIdRefs")]
    public IList<V1beta1ServiceNetworkVPCAssociationSpecInitProviderSecurityGroupIdRefs>? SecurityGroupIdRefs { get; set; }
    ...
    /// <summary>Reference to a ServiceNetwork in vpclattice to populate serviceNetworkIdentifier.</summary>
    [JsonPropertyName("serviceNetworkIdentifierRef")]
    public V1beta1ServiceNetworkVPCAssociationSpecInitProviderServiceNetworkIdentifierRef? ServiceNetworkIdentifierRef { get; set; }

    /// <summary>Selector for a ServiceNetwork in vpclattice to populate serviceNetworkIdentifier.</summary>
    [JsonPropertyName("serviceNetworkIdentifierSelector")]
    public V1beta1ServiceNetworkVPCAssociationSpecInitProviderServiceNetworkIdentifierSelector? ServiceNetworkIdentifierSelector { get; set; }
    ...
    /// <summary>Reference to a VPC in ec2 to populate vpcIdentifier.</summary>
    [JsonPropertyName("vpcIdentifierRef")]
    public V1beta1ServiceNetworkVPCAssociationSpecInitProviderVpcIdentifierRef? VpcIdentifierRef { get; set; }

    /// <summary>Selector for a VPC in ec2 to populate vpcIdentifier.</summary>
    [JsonPropertyName("vpcIdentifierSelector")]
    public V1beta1ServiceNetworkVPCAssociationSpecInitProviderVpcIdentifierSelector? VpcIdentifierSelector { get; set; }
}
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.0+0fbafdb9fc339df17b265ba23ecc4a7be2359877")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1ServiceNetworkVPCAssociationSpecProviderConfigRefPolicyResolutionEnum>))]
public enum V1beta1ServiceNetworkVPCAssociationSpecProviderConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    Required,
    [EnumMember(Value = "Optional"), JsonStringEnumMemberName("Optional")]
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.0+0fbafdb9fc339df17b265ba23ecc4a7be2359877")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1ServiceNetworkVPCAssociationSpecProviderConfigRefPolicyResolveEnum>))]
public enum V1beta1ServiceNetworkVPCAssociationSpecProviderConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    Always,
    [EnumMember(Value = "IfNotPresent"), JsonStringEnumMemberName("IfNotPresent")]
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.0+0fbafdb9fc339df17b265ba23ecc4a7be2359877")]
[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1ServiceNetworkVPCAssociationSpecProviderConfigRefPolicy
{
    /// <summary>
    /// Resolution specifies whether resolution of this reference is required.
    /// The default is &apos;Required&apos;, which means the reconcile will fail if the
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1ServiceNetworkVPCAssociationSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1ServiceNetworkVPCAssociationSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ServiceNetworkVPCAssociationSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1ServiceNetworkVPCAssociationSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1ServiceNetworkVPCAssociationSpec
{
    ...
    public V1beta1ServiceNetworkVPCAssociationSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta1ServiceNetworkVPCAssociationSpecForProvider ForProvider { get; set; }
    ...
    public V1beta1ServiceNetworkVPCAssociationSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1ServiceNetworkVPCAssociationSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1ServiceNetworkVPCAssociationSpecProviderConfigRef? ProviderConfigRef { get; set; }
    ...
    public V1beta1ServiceNetworkVPCAssociationSpecWriteConnectionSecretToRef? WriteConnectionSecretToRef { get; set; }
}
...
public partial class V1beta1ServiceNetworkVPCAssociationStatus
{
    ...
    public V1beta1ServiceNetworkVPCAssociationStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1ServiceNetworkVPCAssociationStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "ServiceNetworkVPCAssociation";
    public const string KubeGroup = "vpclattice.aws.upbound.io";
    public const string KubePluralName = "servicenetworkvpcassociations";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ServiceNetworkVPCAssociation";
    ...
    public required V1beta1ServiceNetworkVPCAssociationSpec Spec { get; set; }

    /// <summary>ServiceNetworkVPCAssociationStatus defines the observed state of ServiceNetworkVPCAssociation.</summary>
    [JsonPropertyName("status")]
    public V1beta1ServiceNetworkVPCAssociationStatus? Status { get; set; }
}