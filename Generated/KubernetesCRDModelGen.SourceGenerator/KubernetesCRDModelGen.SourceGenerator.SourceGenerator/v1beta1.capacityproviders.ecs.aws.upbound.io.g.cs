...
public partial class V1beta1CapacityProviderSpecForProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirements
{
    ...
    public IList<V1beta1CapacityProviderSpecForProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsAcceleratorCount>? AcceleratorCount { get; set; }
    ...
    public IList<V1beta1CapacityProviderSpecForProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsAcceleratorTotalMemoryMib>? AcceleratorTotalMemoryMib { get; set; }
    ...
    public IList<V1beta1CapacityProviderSpecForProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsBaselineEbsBandwidthMbps>? BaselineEbsBandwidthMbps { get; set; }
    ...
    public IList<V1beta1CapacityProviderSpecForProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsMemoryGibPerVcpu>? MemoryGibPerVcpu { get; set; }
    ...
    public IList<V1beta1CapacityProviderSpecForProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsMemoryMib>? MemoryMib { get; set; }
    ...
    public IList<V1beta1CapacityProviderSpecForProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsNetworkBandwidthGbps>? NetworkBandwidthGbps { get; set; }
    ...
    public IList<V1beta1CapacityProviderSpecForProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsNetworkInterfaceCount>? NetworkInterfaceCount { get; set; }
    ...
    public IList<V1beta1CapacityProviderSpecForProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsTotalLocalStorageGb>? TotalLocalStorageGb { get; set; }
    ...
    public IList<V1beta1CapacityProviderSpecForProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsVcpuCount>? VcpuCount { get; set; }
}
...
public partial class V1beta1CapacityProviderSpecForProviderManagedInstancesProviderInstanceLaunchTemplate
{
    ...
    public IList<V1beta1CapacityProviderSpecForProviderManagedInstancesProviderInstanceLaunchTemplateNetworkConfiguration>? NetworkConfiguration { get; set; }
    ...
    public IList<V1beta1CapacityProviderSpecForProviderManagedInstancesProviderInstanceLaunchTemplateStorageConfiguration>? StorageConfiguration { get; set; }
}
...
public partial class V1beta1CapacityProviderSpecForProviderManagedInstancesProvider
{
    ...
    public IList<V1beta1CapacityProviderSpecForProviderManagedInstancesProviderInstanceLaunchTemplate>? InstanceLaunchTemplate { get; set; }
...
public partial class V1beta1CapacityProviderSpecForProvider
{
    ...
    public IList<V1beta1CapacityProviderSpecForProviderManagedInstancesProvider>? ManagedInstancesProvider { get; set; }
...
public partial class V1beta1CapacityProviderSpecInitProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirements
{
    /// <summary>The minimum and maximum number of accelerators for the instance types. This is used when you need instances with specific numbers of GPUs or other accelerators.</summary>
    [JsonPropertyName("acceleratorCount")]
    public IList<V1beta1CapacityProviderSpecInitProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsAcceleratorCount>? AcceleratorCount { get; set; }
    ...
    /// <summary>The minimum and maximum total accelerator memory in mebibytes (MiB). This is important for GPU workloads that require specific amounts of video memory.</summary>
    [JsonPropertyName("acceleratorTotalMemoryMib")]
    public IList<V1beta1CapacityProviderSpecInitProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsAcceleratorTotalMemoryMib>? AcceleratorTotalMemoryMib { get; set; }
    ...
    /// <summary>The minimum and maximum baseline Amazon EBS bandwidth in megabits per second (Mbps). This is important for workloads with high storage I/O requirements.</summary>
    [JsonPropertyName("baselineEbsBandwidthMbps")]
    public IList<V1beta1CapacityProviderSpecInitProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsBaselineEbsBandwidthMbps>? BaselineEbsBandwidthMbps { get; set; }
    ...
    /// <summary>The minimum and maximum amount of memory per vCPU in gibibytes (GiB). This helps ensure that instance types have the appropriate memory-to-CPU ratio for your workloads.</summary>
    [JsonPropertyName("memoryGibPerVcpu")]
    public IList<V1beta1CapacityProviderSpecInitProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsMemoryGibPerVcpu>? MemoryGibPerVcpu { get; set; }

    /// <summary>The minimum and maximum amount of memory in mebibytes (MiB) for the instance types. Amazon ECS selects instance types that have memory within this range.</summary>
    [JsonPropertyName("memoryMib")]
    public IList<V1beta1CapacityProviderSpecInitProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsMemoryMib>? MemoryMib { get; set; }

    /// <summary>The minimum and maximum network bandwidth in gigabits per second (Gbps). This is crucial for network-intensive workloads that require high throughput.</summary>
    [JsonPropertyName("networkBandwidthGbps")]
    public IList<V1beta1CapacityProviderSpecInitProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsNetworkBandwidthGbps>? NetworkBandwidthGbps { get; set; }

    /// <summary>The minimum and maximum number of network interfaces for the instance types. This is useful for workloads that require multiple network interfaces.</summary>
    [JsonPropertyName("networkInterfaceCount")]
    public IList<V1beta1CapacityProviderSpecInitProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsNetworkInterfaceCount>? NetworkInterfaceCount { get; set; }
    ...
    /// <summary>The minimum and maximum total local storage in gigabytes (GB) for instance types with local storage.</summary>
    [JsonPropertyName("totalLocalStorageGb")]
    public IList<V1beta1CapacityProviderSpecInitProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsTotalLocalStorageGb>? TotalLocalStorageGb { get; set; }

    /// <summary>The minimum and maximum number of vCPUs for the instance types. Amazon ECS selects instance types that have vCPU counts within this range.</summary>
    [JsonPropertyName("vcpuCount")]
    public IList<V1beta1CapacityProviderSpecInitProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsVcpuCount>? VcpuCount { get; set; }
}
...
public partial class V1beta1CapacityProviderSpecInitProviderManagedInstancesProviderInstanceLaunchTemplate
{
    ...
    /// <summary>The network configuration for Amazon ECS Managed Instances. This specifies the subnets and security groups that instances use for network connectivity. Detailed below.</summary>
    [JsonPropertyName("networkConfiguration")]
    public IList<V1beta1CapacityProviderSpecInitProviderManagedInstancesProviderInstanceLaunchTemplateNetworkConfiguration>? NetworkConfiguration { get; set; }

    /// <summary>The storage configuration for Amazon ECS Managed Instances. This defines the root volume size and type for the instances. Detailed below.</summary>
    [JsonPropertyName("storageConfiguration")]
    public IList<V1beta1CapacityProviderSpecInitProviderManagedInstancesProviderInstanceLaunchTemplateStorageConfiguration>? StorageConfiguration { get; set; }
}
...
public partial class V1beta1CapacityProviderSpecInitProviderManagedInstancesProvider
{
    ...
    /// <summary>The launch template configuration that specifies how Amazon ECS should launch Amazon EC2 instances. This includes the instance profile, network configuration, storage settings, and instance requirements for attribute-based instance type selection. For more information, see Store instance launch parameters in Amazon EC2 launch templates in the Amazon EC2 User Guide. Detailed below.</summary>
    [JsonPropertyName("instanceLaunchTemplate")]
    public IList<V1beta1CapacityProviderSpecInitProviderManagedInstancesProviderInstanceLaunchTemplate>? InstanceLaunchTemplate { get; set; }
...
public partial class V1beta1CapacityProviderSpecInitProvider
{
    ...
    /// <summary>Configuration block for the managed instances provider. Detailed below. Exactly one of auto_scaling_group_provider or managed_instances_provider must be specified.</summary>
    [JsonPropertyName("managedInstancesProvider")]
    public IList<V1beta1CapacityProviderSpecInitProviderManagedInstancesProvider>? ManagedInstancesProvider { get; set; }
...
public partial class V1beta1CapacityProviderStatusAtProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirements
{
    /// <summary>The minimum and maximum number of accelerators for the instance types. This is used when you need instances with specific numbers of GPUs or other accelerators.</summary>
    [JsonPropertyName("acceleratorCount")]
    public IList<V1beta1CapacityProviderStatusAtProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsAcceleratorCount>? AcceleratorCount { get; set; }
    ...
    /// <summary>The minimum and maximum total accelerator memory in mebibytes (MiB). This is important for GPU workloads that require specific amounts of video memory.</summary>
    [JsonPropertyName("acceleratorTotalMemoryMib")]
    public IList<V1beta1CapacityProviderStatusAtProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsAcceleratorTotalMemoryMib>? AcceleratorTotalMemoryMib { get; set; }
    ...
    /// <summary>The minimum and maximum baseline Amazon EBS bandwidth in megabits per second (Mbps). This is important for workloads with high storage I/O requirements.</summary>
    [JsonPropertyName("baselineEbsBandwidthMbps")]
    public IList<V1beta1CapacityProviderStatusAtProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsBaselineEbsBandwidthMbps>? BaselineEbsBandwidthMbps { get; set; }
    ...
    /// <summary>The minimum and maximum amount of memory per vCPU in gibibytes (GiB). This helps ensure that instance types have the appropriate memory-to-CPU ratio for your workloads.</summary>
    [JsonPropertyName("memoryGibPerVcpu")]
    public IList<V1beta1CapacityProviderStatusAtProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsMemoryGibPerVcpu>? MemoryGibPerVcpu { get; set; }

    /// <summary>The minimum and maximum amount of memory in mebibytes (MiB) for the instance types. Amazon ECS selects instance types that have memory within this range.</summary>
    [JsonPropertyName("memoryMib")]
    public IList<V1beta1CapacityProviderStatusAtProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsMemoryMib>? MemoryMib { get; set; }

    /// <summary>The minimum and maximum network bandwidth in gigabits per second (Gbps). This is crucial for network-intensive workloads that require high throughput.</summary>
    [JsonPropertyName("networkBandwidthGbps")]
    public IList<V1beta1CapacityProviderStatusAtProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsNetworkBandwidthGbps>? NetworkBandwidthGbps { get; set; }

    /// <summary>The minimum and maximum number of network interfaces for the instance types. This is useful for workloads that require multiple network interfaces.</summary>
    [JsonPropertyName("networkInterfaceCount")]
    public IList<V1beta1CapacityProviderStatusAtProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsNetworkInterfaceCount>? NetworkInterfaceCount { get; set; }
    ...
    /// <summary>The minimum and maximum total local storage in gigabytes (GB) for instance types with local storage.</summary>
    [JsonPropertyName("totalLocalStorageGb")]
    public IList<V1beta1CapacityProviderStatusAtProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsTotalLocalStorageGb>? TotalLocalStorageGb { get; set; }

    /// <summary>The minimum and maximum number of vCPUs for the instance types. Amazon ECS selects instance types that have vCPU counts within this range.</summary>
    [JsonPropertyName("vcpuCount")]
    public IList<V1beta1CapacityProviderStatusAtProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsVcpuCount>? VcpuCount { get; set; }
}
...
public partial class V1beta1CapacityProviderStatusAtProviderManagedInstancesProviderInstanceLaunchTemplate
{
    ...
    /// <summary>The network configuration for Amazon ECS Managed Instances. This specifies the subnets and security groups that instances use for network connectivity. Detailed below.</summary>
    [JsonPropertyName("networkConfiguration")]
    public IList<V1beta1CapacityProviderStatusAtProviderManagedInstancesProviderInstanceLaunchTemplateNetworkConfiguration>? NetworkConfiguration { get; set; }

    /// <summary>The storage configuration for Amazon ECS Managed Instances. This defines the root volume size and type for the instances. Detailed below.</summary>
    [JsonPropertyName("storageConfiguration")]
    public IList<V1beta1CapacityProviderStatusAtProviderManagedInstancesProviderInstanceLaunchTemplateStorageConfiguration>? StorageConfiguration { get; set; }
}
...
public partial class V1beta1CapacityProviderStatusAtProviderManagedInstancesProvider
{
    ...
    /// <summary>The launch template configuration that specifies how Amazon ECS should launch Amazon EC2 instances. This includes the instance profile, network configuration, storage settings, and instance requirements for attribute-based instance type selection. For more information, see Store instance launch parameters in Amazon EC2 launch templates in the Amazon EC2 User Guide. Detailed below.</summary>
    [JsonPropertyName("instanceLaunchTemplate")]
    public IList<V1beta1CapacityProviderStatusAtProviderManagedInstancesProviderInstanceLaunchTemplate>? InstanceLaunchTemplate { get; set; }
...
public partial class V1beta1CapacityProviderStatusAtProvider
{
    ...
    /// <summary>Configuration block for the managed instances provider. Detailed below. Exactly one of auto_scaling_group_provider or managed_instances_provider must be specified.</summary>
    [JsonPropertyName("managedInstancesProvider")]
    public IList<V1beta1CapacityProviderStatusAtProviderManagedInstancesProvider>? ManagedInstancesProvider { get; set; }
