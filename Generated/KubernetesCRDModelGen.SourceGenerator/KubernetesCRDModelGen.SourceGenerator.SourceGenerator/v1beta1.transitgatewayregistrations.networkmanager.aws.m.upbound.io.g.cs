...
public partial class V1beta1TransitGatewayRegistrationList : IKubernetesObject<V1ListMeta>, IItems<V1beta1TransitGatewayRegistration>
{
    ...
    public string Kind { get; set; } = "TransitGatewayRegistrationList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1TransitGatewayRegistration objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1TransitGatewayRegistration> Items { get; set; }
}
...
public partial class V1beta1TransitGatewayRegistrationSpec
{
    ...
    public required V1beta1TransitGatewayRegistrationSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1TransitGatewayRegistration : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1TransitGatewayRegistrationSpec>, IStatus<V1beta1TransitGatewayRegistrationStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "TransitGatewayRegistration";
    ...
    public required V1beta1TransitGatewayRegistrationSpec Spec { get; set; }
