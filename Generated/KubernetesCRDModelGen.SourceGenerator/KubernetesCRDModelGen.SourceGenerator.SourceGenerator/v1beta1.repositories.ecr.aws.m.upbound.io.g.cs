...
public partial class V1beta1RepositorySpecForProvider
{
    ...
    public IList<V1beta1RepositorySpecForProviderImageTagMutabilityExclusionFilter>? ImageTagMutabilityExclusionFilter { get; set; }
...
public partial class V1beta1RepositorySpecInitProvider
{
    ...
    /// <summary>Configuration block that defines filters to specify which image tags can override the default tag mutability setting. Only applicable when image_tag_mutability is set to IMMUTABLE_WITH_EXCLUSION or MUTABLE_WITH_EXCLUSION. See below for schema.</summary>
    [JsonPropertyName("imageTagMutabilityExclusionFilter")]
    public IList<V1beta1RepositorySpecInitProviderImageTagMutabilityExclusionFilter>? ImageTagMutabilityExclusionFilter { get; set; }
...
public partial class V1beta1RepositoryStatusAtProvider
{
    ...
    /// <summary>Configuration block that defines filters to specify which image tags can override the default tag mutability setting. Only applicable when image_tag_mutability is set to IMMUTABLE_WITH_EXCLUSION or MUTABLE_WITH_EXCLUSION. See below for schema.</summary>
    [JsonPropertyName("imageTagMutabilityExclusionFilter")]
    public IList<V1beta1RepositoryStatusAtProviderImageTagMutabilityExclusionFilter>? ImageTagMutabilityExclusionFilter { get; set; }
