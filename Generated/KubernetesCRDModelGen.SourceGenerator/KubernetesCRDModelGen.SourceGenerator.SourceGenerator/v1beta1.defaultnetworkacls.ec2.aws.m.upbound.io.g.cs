...
public partial class V1beta1DefaultNetworkACLList : IKubernetesObject<V1ListMeta>, IItems<V1beta1DefaultNetworkACL>
{
    ...
    public string Kind { get; set; } = "DefaultNetworkACLList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1DefaultNetworkACL objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1DefaultNetworkACL> Items { get; set; }
}
...
public partial class V1beta1DefaultNetworkACLSpec
{
    ...
    public required V1beta1DefaultNetworkACLSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1DefaultNetworkACL : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1DefaultNetworkACLSpec>, IStatus<V1beta1DefaultNetworkACLStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "DefaultNetworkACL";
    ...
    public required V1beta1DefaultNetworkACLSpec Spec { get; set; }
