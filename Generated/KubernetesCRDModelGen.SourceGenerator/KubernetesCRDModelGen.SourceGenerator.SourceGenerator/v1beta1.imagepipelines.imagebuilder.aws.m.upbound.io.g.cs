...
public partial class V1beta1ImagePipelineList : IKubernetesObject<V1ListMeta>, IItems<V1beta1ImagePipeline>
{
    ...
    public string ApiVersion { get; set; } = "imagebuilder.aws.m.upbound.io/v1beta1";
    ...
    /// <summary>List of V1beta1ImagePipeline objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1ImagePipeline> Items { get; set; }
}
...
public partial class V1beta1ImagePipelineSpecForProvider
{
    ...
    public V1beta1ImagePipelineSpecForProviderLoggingConfiguration? LoggingConfiguration { get; set; }
...
public partial class V1beta1ImagePipelineSpecInitProvider
{
    ...
    /// <summary>Configuration block with logging configuration. Detailed below.</summary>
    [JsonPropertyName("loggingConfiguration")]
    public V1beta1ImagePipelineSpecInitProviderLoggingConfiguration? LoggingConfiguration { get; set; }
...
public partial class V1beta1ImagePipelineSpec
{
    ...
    public required V1beta1ImagePipelineSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1ImagePipelineStatusAtProvider
{
    ...
    /// <summary>Configuration block with logging configuration. Detailed below.</summary>
    [JsonPropertyName("loggingConfiguration")]
    public V1beta1ImagePipelineStatusAtProviderLoggingConfiguration? LoggingConfiguration { get; set; }
...
public partial class V1beta1ImagePipeline : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1ImagePipelineSpec>, IStatus<V1beta1ImagePipelineStatus?>
{
    ...
    public required V1beta1ImagePipelineSpec Spec { get; set; }
