...
public partial class V1beta1DomainSpecForProviderDomainSettings
{
    ...
    public IList<V1beta1DomainSpecForProviderDomainSettingsTrustedIdentityPropagationSettings>? TrustedIdentityPropagationSettings { get; set; }
}
...
public partial class V1beta1DomainSpecInitProviderDomainSettings
{
    ...
    /// <summary>Configuration for trusted identity propagation. See the trusted_identity_propagation_settings Block below.</summary>
    [JsonPropertyName("trustedIdentityPropagationSettings")]
    public IList<V1beta1DomainSpecInitProviderDomainSettingsTrustedIdentityPropagationSettings>? TrustedIdentityPropagationSettings { get; set; }
}
...
public partial class V1beta1DomainStatusAtProviderDomainSettings
{
    ...
    /// <summary>Configuration for trusted identity propagation. See the trusted_identity_propagation_settings Block below.</summary>
    [JsonPropertyName("trustedIdentityPropagationSettings")]
    public IList<V1beta1DomainStatusAtProviderDomainSettingsTrustedIdentityPropagationSettings>? TrustedIdentityPropagationSettings { get; set; }
}
