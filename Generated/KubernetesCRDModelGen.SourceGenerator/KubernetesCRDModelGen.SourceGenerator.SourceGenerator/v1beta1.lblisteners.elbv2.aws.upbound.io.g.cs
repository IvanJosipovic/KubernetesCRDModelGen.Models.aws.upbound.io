...
public partial class V1beta1LBListenerList : IKubernetesObject<V1ListMeta>, IItems<V1beta1LBListener>
{
    ...
    /// <summary>List of V1beta1LBListener objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1LBListener> Items { get; set; }
}
...
public partial class V1beta1LBListenerSpecForProviderDefaultActionJwtValidation
{
    ...
    public IList<V1beta1LBListenerSpecForProviderDefaultActionJwtValidationAdditionalClaim>? AdditionalClaim { get; set; }
...
public partial class V1beta1LBListenerSpecForProviderDefaultAction
{
    ...
    public IList<V1beta1LBListenerSpecForProviderDefaultActionJwtValidation>? JwtValidation { get; set; }
...
public partial class V1beta1LBListenerSpecInitProviderDefaultActionAuthenticateOidc
{
    ...
    /// <summary>OAuth 2.0 client secret.</summary>
    [JsonPropertyName("clientSecretSecretRef")]
    public required V1beta1LBListenerSpecInitProviderDefaultActionAuthenticateOidcClientSecretSecretRef ClientSecretSecretRef { get; set; }
...
public partial class V1beta1LBListenerSpecInitProviderDefaultActionJwtValidation
{
    /// <summary>Repeatable configuration block for additional claims to validate.</summary>
    [JsonPropertyName("additionalClaim")]
    public IList<V1beta1LBListenerSpecInitProviderDefaultActionJwtValidationAdditionalClaim>? AdditionalClaim { get; set; }
...
public partial class V1beta1LBListenerSpecInitProviderDefaultAction
{
    ...
    /// <summary>Configuration block for creating a JWT validation action. Required if type is jwt-validation.</summary>
    [JsonPropertyName("jwtValidation")]
    public IList<V1beta1LBListenerSpecInitProviderDefaultActionJwtValidation>? JwtValidation { get; set; }
...
public partial class V1beta1LBListenerSpec
{
    ...
    public required V1beta1LBListenerSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1LBListenerStatusAtProviderDefaultActionJwtValidation
{
    /// <summary>Repeatable configuration block for additional claims to validate.</summary>
    [JsonPropertyName("additionalClaim")]
    public IList<V1beta1LBListenerStatusAtProviderDefaultActionJwtValidationAdditionalClaim>? AdditionalClaim { get; set; }
...
public partial class V1beta1LBListenerStatusAtProviderDefaultAction
{
    ...
    /// <summary>Configuration block for creating a JWT validation action. Required if type is jwt-validation.</summary>
    [JsonPropertyName("jwtValidation")]
    public IList<V1beta1LBListenerStatusAtProviderDefaultActionJwtValidation>? JwtValidation { get; set; }
...
public partial class V1beta1LBListener : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1LBListenerSpec>, IStatus<V1beta1LBListenerStatus?>
{
    ...
    public required V1beta1LBListenerSpec Spec { get; set; }
