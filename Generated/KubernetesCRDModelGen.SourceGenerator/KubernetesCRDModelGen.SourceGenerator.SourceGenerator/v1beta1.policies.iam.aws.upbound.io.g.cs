...
{
    /// <summary>Number of ms to wait between creating the policy and setting its version as default. May be required in environments with very high S3 IO loads.</summary>
    [JsonPropertyName("delayAfterPolicyCreationInMs")]
