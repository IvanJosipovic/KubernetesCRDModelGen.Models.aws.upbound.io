...
public partial class V1beta1SigningProfileList : IKubernetesObject<V1ListMeta>, IItems<V1beta1SigningProfile>
{
    ...
    public string ApiVersion { get; set; } = "signer.aws.m.upbound.io/v1beta1";
    ...
    /// <summary>List of V1beta1SigningProfile objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1SigningProfile> Items { get; set; }
}
...
public partial class V1beta1SigningProfileSpec
{
    ...
    public required V1beta1SigningProfileSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1SigningProfile : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1SigningProfileSpec>, IStatus<V1beta1SigningProfileStatus?>
{
    ...
    public required V1beta1SigningProfileSpec Spec { get; set; }
