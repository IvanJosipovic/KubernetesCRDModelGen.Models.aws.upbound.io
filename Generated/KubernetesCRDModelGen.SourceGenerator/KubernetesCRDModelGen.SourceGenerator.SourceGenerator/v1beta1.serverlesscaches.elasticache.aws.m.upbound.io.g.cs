...
public partial class V1beta1ServerlessCacheList : IKubernetesObject<V1ListMeta>, IItems<V1beta1ServerlessCache>
{
    ...
    public string ApiVersion { get; set; } = "elasticache.aws.m.upbound.io/v1beta1";
    ...
    /// <summary>List of V1beta1ServerlessCache objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1ServerlessCache> Items { get; set; }
}
...
public partial class V1beta1ServerlessCacheSpecForProvider
{
    ...
    /// <summary>The list of ARN(s) of the snapshot that the new serverless cache will be created from. Only supported for engine types &quot;redis&quot; or &quot;valkey&quot;.</summary>
    [JsonPropertyName("snapshotArnsToRestore")]
    public IList<string>? SnapshotArnsToRestore { get; set; }

    /// <summary>The number of snapshots that will be retained for the serverless cache that is being created. As new snapshots beyond this limit are added, the oldest snapshots will be deleted on a rolling basis. Only supported for engine types &quot;redis&quot; or &quot;valkey&quot;.</summary>
    ...
    /// <summary>The identifier of the UserGroup to be associated with the serverless cache. Available for Redis and Valkey. Default is NULL.</summary>
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.0+0fbafdb9fc339df17b265ba23ecc4a7be2359877")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1ServerlessCacheSpecManagementPoliciesEnum>))]
...
public partial class V1beta1ServerlessCacheSpec
{
    ...
    public required V1beta1ServerlessCacheSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1ServerlessCache : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1ServerlessCacheSpec>, IStatus<V1beta1ServerlessCacheStatus?>
{
    ...
    public required V1beta1ServerlessCacheSpec Spec { get; set; }
