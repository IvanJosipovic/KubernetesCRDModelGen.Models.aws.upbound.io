...
public partial class V1beta1ServerCertificateList : IKubernetesObject<V1ListMeta>, IItems<V1beta1ServerCertificate>
{
    ...
    public string Kind { get; set; } = "ServerCertificateList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1ServerCertificate objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1ServerCertificate> Items { get; set; }
}
...
public partial class V1beta1ServerCertificateSpecInitProvider
{
    ...
    /// <summary>The contents of the private key in PEM-encoded format.</summary>
    [JsonPropertyName("privateKeySecretRef")]
    public required V1beta1ServerCertificateSpecInitProviderPrivateKeySecretRef PrivateKeySecretRef { get; set; }
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.0+0fbafdb9fc339df17b265ba23ecc4a7be2359877")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1ServerCertificateSpecManagementPoliciesEnum>))]
...
public partial class V1beta1ServerCertificateSpec
{
    ...
    public required V1beta1ServerCertificateSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1ServerCertificate : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1ServerCertificateSpec>, IStatus<V1beta1ServerCertificateStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ServerCertificate";
    ...
    public required V1beta1ServerCertificateSpec Spec { get; set; }
