...
{
    /// <summary>Whether any database modifications are applied immediately, or during the next maintenance window. Default isfalse.</summary>
    [JsonPropertyName("applyImmediately")]
    public bool? ApplyImmediately { get; set; }

    /// <summary>Parameter does not apply to Amazon DocumentDB. Amazon DocumentDB does not perform minor version upgrades regardless of the value set (see docs). Default true.</summary>
    ...
    /// <summary>Identifier of the certificate authority (CA) certificate for the DB instance.</summary>
    [JsonPropertyName("caCertIdentifier")]
    public string? CaCertIdentifier { get; set; }

    /// <summary>–  Whether to restart the DB instance when rotating its SSL/TLS certificate. By default, AWS restarts the DB instance when you rotate your SSL/TLS certificate. The certificate is not updated until the DB instance is restarted. Set to false only if you are not using SSL/TLS to connect to the DB instance.</summary>
    [JsonPropertyName("certificateRotationRestart")]
    public string? CertificateRotationRestart { get; set; }

    /// <summary>Identifier of the aws_docdb_cluster in which to launch this instance.</summary>
    ...
    /// <summary>Value that indicates whether to enable Performance Insights for the DB Instance. Default false. See [docs] (https://docs.aws.amazon.com/documentdb/latest/developerguide/performance-insights.html) about the details.</summary>
    [JsonPropertyName("enablePerformanceInsights")]
    public bool? EnablePerformanceInsights { get; set; }

    /// <summary>Name of the database engine to be used for the DocumentDB instance. Defaults to docdb. Valid Values: docdb.</summary>
    [JsonPropertyName("engine")]
    public string? Engine { get; set; }

    /// <summary>Instance class to use. For details on CPU and memory, see Scaling for DocumentDB Instances. See the aws_docdb_orderable_db_instance data source. See AWS Documentation for complete details.</summary>
    [JsonPropertyName("instanceClass")]
    public string? InstanceClass { get; set; }

    /// <summary>KMS key identifier is the key ARN, key ID, alias ARN, or alias name for the KMS key. If you do not specify a value for PerformanceInsightsKMSKeyId, then Amazon DocumentDB uses your default KMS key.</summary>
    ...
    /// <summary>Failover Priority setting on instance level. Default 0. The reader who has lower tier has higher priority to get promoter to writer.</summary>
...
public partial class V1beta1ClusterInstanceStatusAtProvider
{
    ...
    /// <summary>DB subnet group to associate with this DB instance.</summary>
    ...
    /// <summary>Daily time range during which automated backups are created if automated backups are enabled.</summary>
    ...
    /// <summary>Whether this instance is writable. False indicates this instance is a read replica.</summary>
