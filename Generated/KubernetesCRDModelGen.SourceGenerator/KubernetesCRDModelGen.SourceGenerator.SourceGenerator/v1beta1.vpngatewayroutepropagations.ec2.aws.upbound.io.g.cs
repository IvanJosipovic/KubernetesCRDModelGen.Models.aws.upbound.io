...
public partial class V1beta1VPNGatewayRoutePropagationList : IKubernetesObject<V1ListMeta>, IItems<V1beta1VPNGatewayRoutePropagation>
{
    ...
    public string Kind { get; set; } = "VPNGatewayRoutePropagationList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1VPNGatewayRoutePropagation objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1VPNGatewayRoutePropagation> Items { get; set; }
}
...
public partial class V1beta1VPNGatewayRoutePropagationSpec
{
    ...
    public required V1beta1VPNGatewayRoutePropagationSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1VPNGatewayRoutePropagation : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1VPNGatewayRoutePropagationSpec>, IStatus<V1beta1VPNGatewayRoutePropagationStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "VPNGatewayRoutePropagation";
    ...
    public required V1beta1VPNGatewayRoutePropagationSpec Spec { get; set; }
