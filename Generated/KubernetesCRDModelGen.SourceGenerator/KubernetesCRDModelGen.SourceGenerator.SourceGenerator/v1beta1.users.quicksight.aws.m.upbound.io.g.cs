...
public partial class V1beta1UserList : IKubernetesObject<V1ListMeta>, IItems<V1beta1User>
{
    ...
    public string ApiVersion { get; set; } = "quicksight.aws.m.upbound.io/v1beta1";
...
public partial class V1beta1UserSpecForProvider
{
    ...
    /// <summary>Identity type that your Amazon QuickSight account uses to manage the identity of users. Valid values: IAM, QUICKSIGHT, IAM_IDENTITY_CENTER.</summary>
    ...
    /// <summary>Amazon QuickSight role for the user. Valid values: READER, AUTHOR, ADMIN, READER_PRO, AUTHOR_PRO, ADMIN_PRO, RESTRICTED_AUTHOR, RESTRICTED_READER.</summary>
