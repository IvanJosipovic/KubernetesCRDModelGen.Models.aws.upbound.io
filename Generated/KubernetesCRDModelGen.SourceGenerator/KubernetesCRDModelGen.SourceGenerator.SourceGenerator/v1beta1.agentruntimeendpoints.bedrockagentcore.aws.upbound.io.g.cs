...
public partial class V1beta1AgentRuntimeEndpointList : IKubernetesObject<V1ListMeta>, IItems<V1beta1AgentRuntimeEndpoint>
{
    ...
    public const string KubeKind = "AgentRuntimeEndpointList";
    public const string KubeGroup = "bedrockagentcore.aws.upbound.io";
    public const string KubePluralName = "agentruntimeendpoints";
    ...
    public string Kind { get; set; } = "AgentRuntimeEndpointList";
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.5.3+0316f97acf12de380316633df08e7f13a064978d")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1AgentRuntimeEndpointSpecDeletionPolicyEnum>))]
public enum V1beta1AgentRuntimeEndpointSpecDeletionPolicyEnum
{
...
public partial class V1beta1AgentRuntimeEndpointSpecForProviderAgentRuntimeIdRefPolicy
{
    ...
    public V1beta1AgentRuntimeEndpointSpecForProviderAgentRuntimeIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1AgentRuntimeEndpointSpecForProviderAgentRuntimeIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1AgentRuntimeEndpointSpecForProviderAgentRuntimeIdRef
{
    ...
    public V1beta1AgentRuntimeEndpointSpecForProviderAgentRuntimeIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1AgentRuntimeEndpointSpecForProviderAgentRuntimeIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1AgentRuntimeEndpointSpecForProviderAgentRuntimeIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1AgentRuntimeEndpointSpecForProviderAgentRuntimeIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
{
    /// <summary>ID of the agent runtime this endpoint belongs to.</summary>
    [JsonPropertyName("agentRuntimeId")]
    public string? AgentRuntimeId { get; set; }

    /// <summary>Reference to a AgentRuntime in bedrockagentcore to populate agentRuntimeId.</summary>
    [JsonPropertyName("agentRuntimeIdRef")]
    public V1beta1AgentRuntimeEndpointSpecForProviderAgentRuntimeIdRef? AgentRuntimeIdRef { get; set; }

    /// <summary>Selector for a AgentRuntime in bedrockagentcore to populate agentRuntimeId.</summary>
    [JsonPropertyName("agentRuntimeIdSelector")]
    public V1beta1AgentRuntimeEndpointSpecForProviderAgentRuntimeIdSelector? AgentRuntimeIdSelector { get; set; }

    /// <summary>Version of the agent runtime to use for this endpoint.</summary>
    [JsonPropertyName("agentRuntimeVersion")]
    public string? AgentRuntimeVersion { get; set; }

    /// <summary>Description of the agent runtime endpoint.</summary>
    [JsonPropertyName("description")]
    public string? Description { get; set; }

    /// <summary>Name of the agent runtime endpoint.</summary>
    [JsonPropertyName("name")]
    public required string Name { get; set; }
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.5.3+0316f97acf12de380316633df08e7f13a064978d")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1AgentRuntimeEndpointSpecProviderConfigRefPolicyResolutionEnum>))]
public enum V1beta1AgentRuntimeEndpointSpecProviderConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    Required,
    [EnumMember(Value = "Optional"), JsonStringEnumMemberName("Optional")]
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.5.3+0316f97acf12de380316633df08e7f13a064978d")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1AgentRuntimeEndpointSpecProviderConfigRefPolicyResolveEnum>))]
public enum V1beta1AgentRuntimeEndpointSpecProviderConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    Always,
    [EnumMember(Value = "IfNotPresent"), JsonStringEnumMemberName("IfNotPresent")]
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.5.3+0316f97acf12de380316633df08e7f13a064978d")]
[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1AgentRuntimeEndpointSpecProviderConfigRefPolicy
{
    /// <summary>
    /// Resolution specifies whether resolution of this reference is required.
    /// The default is &apos;Required&apos;, which means the reconcile will fail if the
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1AgentRuntimeEndpointSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1AgentRuntimeEndpointSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1AgentRuntimeEndpointSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1AgentRuntimeEndpointSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1AgentRuntimeEndpointSpec
{
    ...
    public V1beta1AgentRuntimeEndpointSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta1AgentRuntimeEndpointSpecForProvider ForProvider { get; set; }
    ...
    public V1beta1AgentRuntimeEndpointSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1AgentRuntimeEndpointSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1AgentRuntimeEndpointSpecProviderConfigRef? ProviderConfigRef { get; set; }
...
{
    /// <summary>ARN of the associated Agent Runtime.</summary>
    [JsonPropertyName("agentRuntimeArn")]
    public string? AgentRuntimeArn { get; set; }

    /// <summary>ARN of the Agent Runtime Endpoint.</summary>
    [JsonPropertyName("agentRuntimeEndpointArn")]
...
public partial class V1beta1AgentRuntimeEndpointStatus
{
    ...
    public V1beta1AgentRuntimeEndpointStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1AgentRuntimeEndpointStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "AgentRuntimeEndpoint";
    public const string KubeGroup = "bedrockagentcore.aws.upbound.io";
    public const string KubePluralName = "agentruntimeendpoints";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "AgentRuntimeEndpoint";
    ...
    public required V1beta1AgentRuntimeEndpointSpec Spec { get; set; }

    /// <summary>AgentRuntimeEndpointStatus defines the observed state of AgentRuntimeEndpoint.</summary>
    [JsonPropertyName("status")]
    public V1beta1AgentRuntimeEndpointStatus? Status { get; set; }
}