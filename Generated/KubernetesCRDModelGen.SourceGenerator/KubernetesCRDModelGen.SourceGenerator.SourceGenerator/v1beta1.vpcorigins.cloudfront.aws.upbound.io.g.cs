...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.5.2+8c7b4a3647c1e77cd3e3152af5701ec2357dafe9")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1VPCOriginSpecDeletionPolicyEnum>))]
public enum V1beta1VPCOriginSpecDeletionPolicyEnum
{
...
public partial class V1beta1VPCOriginSpecForProviderVpcOriginEndpointConfigArnRefPolicy
{
    ...
    public V1beta1VPCOriginSpecForProviderVpcOriginEndpointConfigArnRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1VPCOriginSpecForProviderVpcOriginEndpointConfigArnRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VPCOriginSpecForProviderVpcOriginEndpointConfigArnRef
{
    ...
    public V1beta1VPCOriginSpecForProviderVpcOriginEndpointConfigArnRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1VPCOriginSpecForProviderVpcOriginEndpointConfigArnSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1VPCOriginSpecForProviderVpcOriginEndpointConfigArnSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1VPCOriginSpecForProviderVpcOriginEndpointConfigArnSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VPCOriginSpecForProviderVpcOriginEndpointConfigArnSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1VPCOriginSpecForProviderVpcOriginEndpointConfigArnSelectorPolicy? Policy { get; set; }
}
...
{
    /// <summary>The ARN of the CloudFront VPC origin endpoint configuration.</summary>
    [JsonPropertyName("arn")]
    public string? Arn { get; set; }

    /// <summary>Reference to a LB in elbv2 to populate arn.</summary>
    [JsonPropertyName("arnRef")]
    public V1beta1VPCOriginSpecForProviderVpcOriginEndpointConfigArnRef? ArnRef { get; set; }

    /// <summary>Selector for a LB in elbv2 to populate arn.</summary>
    [JsonPropertyName("arnSelector")]
    public V1beta1VPCOriginSpecForProviderVpcOriginEndpointConfigArnSelector? ArnSelector { get; set; }

    /// <summary>The HTTP port for the CloudFront VPC origin endpoint configuration.</summary>
    [JsonPropertyName("httpPort")]
    public double? HttpPort { get; set; }

    /// <summary>The HTTPS port for the CloudFront VPC origin endpoint configuration.</summary>
    [JsonPropertyName("httpsPort")]
    public double? HttpsPort { get; set; }

    /// <summary>The name of the CloudFront VPC origin endpoint configuration.</summary>
    [JsonPropertyName("name")]
    public string? Name { get; set; }

    /// <summary>The origin protocol policy for the CloudFront VPC origin endpoint configuration.</summary>
...
public partial class V1beta1VPCOriginSpecForProvider
{
    ...
    public V1beta1VPCOriginSpecForProviderVpcOriginEndpointConfig? VpcOriginEndpointConfig { get; set; }
}
...
public partial class V1beta1VPCOriginSpecInitProviderVpcOriginEndpointConfigArnRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1VPCOriginSpecInitProviderVpcOriginEndpointConfigArnRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1VPCOriginSpecInitProviderVpcOriginEndpointConfigArnRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VPCOriginSpecInitProviderVpcOriginEndpointConfigArnRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1VPCOriginSpecInitProviderVpcOriginEndpointConfigArnRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1VPCOriginSpecInitProviderVpcOriginEndpointConfigArnSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1VPCOriginSpecInitProviderVpcOriginEndpointConfigArnSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1VPCOriginSpecInitProviderVpcOriginEndpointConfigArnSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VPCOriginSpecInitProviderVpcOriginEndpointConfigArnSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1VPCOriginSpecInitProviderVpcOriginEndpointConfigArnSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1VPCOriginSpecInitProviderVpcOriginEndpointConfig
{
    ...
    /// <summary>Reference to a LB in elbv2 to populate arn.</summary>
    [JsonPropertyName("arnRef")]
    public V1beta1VPCOriginSpecInitProviderVpcOriginEndpointConfigArnRef? ArnRef { get; set; }

    /// <summary>Selector for a LB in elbv2 to populate arn.</summary>
    [JsonPropertyName("arnSelector")]
    public V1beta1VPCOriginSpecInitProviderVpcOriginEndpointConfigArnSelector? ArnSelector { get; set; }
    ...
    /// <summary>A complex type that contains information about the SSL/TLS protocols that CloudFront can use when establishing an HTTPS connection with your origin.</summary>
    [JsonPropertyName("originSslProtocols")]
    public V1beta1VPCOriginSpecInitProviderVpcOriginEndpointConfigOriginSslProtocols? OriginSslProtocols { get; set; }
}
...
public partial class V1beta1VPCOriginSpecInitProvider
{
    ...
    /// <summary>The VPC origin endpoint configuration.</summary>
    [JsonPropertyName("vpcOriginEndpointConfig")]
    public V1beta1VPCOriginSpecInitProviderVpcOriginEndpointConfig? VpcOriginEndpointConfig { get; set; }
}
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.5.2+8c7b4a3647c1e77cd3e3152af5701ec2357dafe9")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1VPCOriginSpecProviderConfigRefPolicyResolutionEnum>))]
public enum V1beta1VPCOriginSpecProviderConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    Required,
    [EnumMember(Value = "Optional"), JsonStringEnumMemberName("Optional")]
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.5.2+8c7b4a3647c1e77cd3e3152af5701ec2357dafe9")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1VPCOriginSpecProviderConfigRefPolicyResolveEnum>))]
public enum V1beta1VPCOriginSpecProviderConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    Always,
    [EnumMember(Value = "IfNotPresent"), JsonStringEnumMemberName("IfNotPresent")]
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.5.2+8c7b4a3647c1e77cd3e3152af5701ec2357dafe9")]
[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1VPCOriginSpecProviderConfigRefPolicy
{
    /// <summary>
    /// Resolution specifies whether resolution of this reference is required.
    /// The default is &apos;Required&apos;, which means the reconcile will fail if the
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1VPCOriginSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1VPCOriginSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1VPCOriginSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1VPCOriginSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1VPCOriginSpec
{
    ...
    public V1beta1VPCOriginSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta1VPCOriginSpecForProvider ForProvider { get; set; }
    ...
    public V1beta1VPCOriginSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1VPCOriginSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1VPCOriginSpecProviderConfigRef? ProviderConfigRef { get; set; }
    ...
    public V1beta1VPCOriginSpecWriteConnectionSecretToRef? WriteConnectionSecretToRef { get; set; }
}
...
public partial class V1beta1VPCOriginStatusAtProvider
{
    ...
    /// <summary>The current version of the origin.</summary>
    ...
    /// <summary>The VPC origin endpoint configuration.</summary>
    [JsonPropertyName("vpcOriginEndpointConfig")]
    public V1beta1VPCOriginStatusAtProviderVpcOriginEndpointConfig? VpcOriginEndpointConfig { get; set; }
}
...
public partial class V1beta1VPCOriginStatus
{
    ...
    public V1beta1VPCOriginStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1VPCOriginStatusConditions>? Conditions { get; set; }
...
public partial class V1beta1VPCOrigin : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1VPCOriginSpec>, IStatus<V1beta1VPCOriginStatus?>
{
    ...
    public required V1beta1VPCOriginSpec Spec { get; set; }

    /// <summary>VPCOriginStatus defines the observed state of VPCOrigin.</summary>
    [JsonPropertyName("status")]
    public V1beta1VPCOriginStatus? Status { get; set; }
}