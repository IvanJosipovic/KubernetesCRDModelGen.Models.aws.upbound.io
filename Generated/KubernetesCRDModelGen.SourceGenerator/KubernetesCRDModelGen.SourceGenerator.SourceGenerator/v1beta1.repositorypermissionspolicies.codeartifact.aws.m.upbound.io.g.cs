...
public partial class V1beta1RepositoryPermissionsPolicyList : IKubernetesObject<V1ListMeta>, IItems<V1beta1RepositoryPermissionsPolicy>
{
    ...
    public string Kind { get; set; } = "RepositoryPermissionsPolicyList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1RepositoryPermissionsPolicy objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1RepositoryPermissionsPolicy> Items { get; set; }
}
...
public partial class V1beta1RepositoryPermissionsPolicySpec
{
    ...
    public required V1beta1RepositoryPermissionsPolicySpecForProvider ForProvider { get; set; }
...
public partial class V1beta1RepositoryPermissionsPolicy : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1RepositoryPermissionsPolicySpec>, IStatus<V1beta1RepositoryPermissionsPolicyStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "RepositoryPermissionsPolicy";
    ...
    public required V1beta1RepositoryPermissionsPolicySpec Spec { get; set; }
