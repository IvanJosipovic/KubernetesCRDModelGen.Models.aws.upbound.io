...
public partial class V1beta1InstanceTrustProviderAttachmentList : IKubernetesObject<V1ListMeta>, IItems<V1beta1InstanceTrustProviderAttachment>
{
    ...
    public const string KubeKind = "InstanceTrustProviderAttachmentList";
    public const string KubeGroup = "verifiedaccess.aws.upbound.io";
    public const string KubePluralName = "instancetrustproviderattachments";
    ...
    public string Kind { get; set; } = "InstanceTrustProviderAttachmentList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1InstanceTrustProviderAttachment objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1InstanceTrustProviderAttachment> Items { get; set; }
}
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.0+0fbafdb9fc339df17b265ba23ecc4a7be2359877")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1InstanceTrustProviderAttachmentSpecDeletionPolicyEnum>))]
public enum V1beta1InstanceTrustProviderAttachmentSpecDeletionPolicyEnum
{
...
public partial class V1beta1InstanceTrustProviderAttachmentSpecForProviderVerifiedaccessInstanceIdRefPolicy
{
    ...
    public V1beta1InstanceTrustProviderAttachmentSpecForProviderVerifiedaccessInstanceIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1InstanceTrustProviderAttachmentSpecForProviderVerifiedaccessInstanceIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1InstanceTrustProviderAttachmentSpecForProviderVerifiedaccessInstanceIdRef
{
    ...
    public V1beta1InstanceTrustProviderAttachmentSpecForProviderVerifiedaccessInstanceIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1InstanceTrustProviderAttachmentSpecForProviderVerifiedaccessInstanceIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1InstanceTrustProviderAttachmentSpecForProviderVerifiedaccessInstanceIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1InstanceTrustProviderAttachmentSpecForProviderVerifiedaccessInstanceIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1InstanceTrustProviderAttachmentSpecForProviderVerifiedaccessInstanceIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1InstanceTrustProviderAttachmentSpecForProviderVerifiedaccessInstanceIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1InstanceTrustProviderAttachmentSpecForProviderVerifiedaccessTrustProviderIdRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1InstanceTrustProviderAttachmentSpecForProviderVerifiedaccessTrustProviderIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1InstanceTrustProviderAttachmentSpecForProviderVerifiedaccessTrustProviderIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1InstanceTrustProviderAttachmentSpecForProviderVerifiedaccessTrustProviderIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1InstanceTrustProviderAttachmentSpecForProviderVerifiedaccessTrustProviderIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1InstanceTrustProviderAttachmentSpecForProviderVerifiedaccessTrustProviderIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1InstanceTrustProviderAttachmentSpecForProviderVerifiedaccessTrustProviderIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1InstanceTrustProviderAttachmentSpecForProviderVerifiedaccessTrustProviderIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1InstanceTrustProviderAttachmentSpecForProvider
{
    ...
    /// <summary>The ID of the Verified Access instance to attach the Trust Provider to.</summary>
    ...
    public V1beta1InstanceTrustProviderAttachmentSpecForProviderVerifiedaccessInstanceIdRef? VerifiedaccessInstanceIdRef { get; set; }

    /// <summary>Selector for a Instance in verifiedaccess to populate verifiedaccessInstanceId.</summary>
    [JsonPropertyName("verifiedaccessInstanceIdSelector")]
    public V1beta1InstanceTrustProviderAttachmentSpecForProviderVerifiedaccessInstanceIdSelector? VerifiedaccessInstanceIdSelector { get; set; }

    /// <summary>The ID of the Verified Access trust provider.</summary>
    [JsonPropertyName("verifiedaccessTrustProviderId")]
    public string? VerifiedaccessTrustProviderId { get; set; }

    /// <summary>Reference to a TrustProvider in verifiedaccess to populate verifiedaccessTrustProviderId.</summary>
    [JsonPropertyName("verifiedaccessTrustProviderIdRef")]
    public V1beta1InstanceTrustProviderAttachmentSpecForProviderVerifiedaccessTrustProviderIdRef? VerifiedaccessTrustProviderIdRef { get; set; }

    /// <summary>Selector for a TrustProvider in verifiedaccess to populate verifiedaccessTrustProviderId.</summary>
    [JsonPropertyName("verifiedaccessTrustProviderIdSelector")]
    public V1beta1InstanceTrustProviderAttachmentSpecForProviderVerifiedaccessTrustProviderIdSelector? VerifiedaccessTrustProviderIdSelector { get; set; }
}
...
public partial class V1beta1InstanceTrustProviderAttachmentSpecInitProviderVerifiedaccessInstanceIdRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1InstanceTrustProviderAttachmentSpecInitProviderVerifiedaccessInstanceIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1InstanceTrustProviderAttachmentSpecInitProviderVerifiedaccessInstanceIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1InstanceTrustProviderAttachmentSpecInitProviderVerifiedaccessInstanceIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1InstanceTrustProviderAttachmentSpecInitProviderVerifiedaccessInstanceIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1InstanceTrustProviderAttachmentSpecInitProviderVerifiedaccessInstanceIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1InstanceTrustProviderAttachmentSpecInitProviderVerifiedaccessInstanceIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1InstanceTrustProviderAttachmentSpecInitProviderVerifiedaccessInstanceIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1InstanceTrustProviderAttachmentSpecInitProviderVerifiedaccessInstanceIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1InstanceTrustProviderAttachmentSpecInitProviderVerifiedaccessInstanceIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1InstanceTrustProviderAttachmentSpecInitProviderVerifiedaccessTrustProviderIdRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1InstanceTrustProviderAttachmentSpecInitProviderVerifiedaccessTrustProviderIdRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1InstanceTrustProviderAttachmentSpecInitProviderVerifiedaccessTrustProviderIdRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1InstanceTrustProviderAttachmentSpecInitProviderVerifiedaccessTrustProviderIdRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1InstanceTrustProviderAttachmentSpecInitProviderVerifiedaccessTrustProviderIdRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1InstanceTrustProviderAttachmentSpecInitProviderVerifiedaccessTrustProviderIdSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1InstanceTrustProviderAttachmentSpecInitProviderVerifiedaccessTrustProviderIdSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1InstanceTrustProviderAttachmentSpecInitProviderVerifiedaccessTrustProviderIdSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1InstanceTrustProviderAttachmentSpecInitProviderVerifiedaccessTrustProviderIdSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1InstanceTrustProviderAttachmentSpecInitProviderVerifiedaccessTrustProviderIdSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1InstanceTrustProviderAttachmentSpecInitProvider
{
    ...
    /// <summary>Reference to a Instance in verifiedaccess to populate verifiedaccessInstanceId.</summary>
    [JsonPropertyName("verifiedaccessInstanceIdRef")]
    public V1beta1InstanceTrustProviderAttachmentSpecInitProviderVerifiedaccessInstanceIdRef? VerifiedaccessInstanceIdRef { get; set; }

    /// <summary>Selector for a Instance in verifiedaccess to populate verifiedaccessInstanceId.</summary>
    [JsonPropertyName("verifiedaccessInstanceIdSelector")]
    public V1beta1InstanceTrustProviderAttachmentSpecInitProviderVerifiedaccessInstanceIdSelector? VerifiedaccessInstanceIdSelector { get; set; }
    ...
    /// <summary>Reference to a TrustProvider in verifiedaccess to populate verifiedaccessTrustProviderId.</summary>
    [JsonPropertyName("verifiedaccessTrustProviderIdRef")]
    public V1beta1InstanceTrustProviderAttachmentSpecInitProviderVerifiedaccessTrustProviderIdRef? VerifiedaccessTrustProviderIdRef { get; set; }

    /// <summary>Selector for a TrustProvider in verifiedaccess to populate verifiedaccessTrustProviderId.</summary>
    [JsonPropertyName("verifiedaccessTrustProviderIdSelector")]
    public V1beta1InstanceTrustProviderAttachmentSpecInitProviderVerifiedaccessTrustProviderIdSelector? VerifiedaccessTrustProviderIdSelector { get; set; }
}
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.0+0fbafdb9fc339df17b265ba23ecc4a7be2359877")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1InstanceTrustProviderAttachmentSpecProviderConfigRefPolicyResolutionEnum>))]
public enum V1beta1InstanceTrustProviderAttachmentSpecProviderConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    Required,
    [EnumMember(Value = "Optional"), JsonStringEnumMemberName("Optional")]
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.0+0fbafdb9fc339df17b265ba23ecc4a7be2359877")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1InstanceTrustProviderAttachmentSpecProviderConfigRefPolicyResolveEnum>))]
public enum V1beta1InstanceTrustProviderAttachmentSpecProviderConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    Always,
    [EnumMember(Value = "IfNotPresent"), JsonStringEnumMemberName("IfNotPresent")]
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.0+0fbafdb9fc339df17b265ba23ecc4a7be2359877")]
[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1InstanceTrustProviderAttachmentSpecProviderConfigRefPolicy
{
    /// <summary>
    /// Resolution specifies whether resolution of this reference is required.
    /// The default is &apos;Required&apos;, which means the reconcile will fail if the
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1InstanceTrustProviderAttachmentSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1InstanceTrustProviderAttachmentSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1InstanceTrustProviderAttachmentSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1InstanceTrustProviderAttachmentSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1InstanceTrustProviderAttachmentSpec
{
    ...
    public V1beta1InstanceTrustProviderAttachmentSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta1InstanceTrustProviderAttachmentSpecForProvider ForProvider { get; set; }
    ...
    public V1beta1InstanceTrustProviderAttachmentSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1InstanceTrustProviderAttachmentSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1InstanceTrustProviderAttachmentSpecProviderConfigRef? ProviderConfigRef { get; set; }
...
{
    /// <summary>A combination of attributes, separated by a / to create a unique id: verifiedaccess_instance_id,verifiedaccess_trust_provider_id</summary>
    [JsonPropertyName("id")]
...
public partial class V1beta1InstanceTrustProviderAttachmentStatus
{
    ...
    public V1beta1InstanceTrustProviderAttachmentStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1InstanceTrustProviderAttachmentStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "InstanceTrustProviderAttachment";
    public const string KubeGroup = "verifiedaccess.aws.upbound.io";
    public const string KubePluralName = "instancetrustproviderattachments";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "InstanceTrustProviderAttachment";
    ...
    public required V1beta1InstanceTrustProviderAttachmentSpec Spec { get; set; }

    /// <summary>InstanceTrustProviderAttachmentStatus defines the observed state of InstanceTrustProviderAttachment.</summary>
    [JsonPropertyName("status")]
    public V1beta1InstanceTrustProviderAttachmentStatus? Status { get; set; }
}