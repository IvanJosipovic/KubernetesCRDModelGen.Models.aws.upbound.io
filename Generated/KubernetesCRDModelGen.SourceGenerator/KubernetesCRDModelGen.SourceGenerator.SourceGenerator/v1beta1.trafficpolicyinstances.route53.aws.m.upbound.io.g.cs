...
public partial class V1beta1TrafficPolicyInstanceList : IKubernetesObject<V1ListMeta>, IItems<V1beta1TrafficPolicyInstance>
{
    ...
    public string Kind { get; set; } = "TrafficPolicyInstanceList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1TrafficPolicyInstance objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1TrafficPolicyInstance> Items { get; set; }
}
...
public partial class V1beta1TrafficPolicyInstanceSpec
{
    ...
    public required V1beta1TrafficPolicyInstanceSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1TrafficPolicyInstance : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1TrafficPolicyInstanceSpec>, IStatus<V1beta1TrafficPolicyInstanceStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "TrafficPolicyInstance";
    ...
    public required V1beta1TrafficPolicyInstanceSpec Spec { get; set; }
