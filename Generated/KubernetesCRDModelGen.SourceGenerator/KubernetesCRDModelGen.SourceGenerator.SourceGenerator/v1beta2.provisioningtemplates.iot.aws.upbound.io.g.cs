...
public partial class V1beta2ProvisioningTemplateList : IKubernetesObject<V1ListMeta>, IItems<V1beta2ProvisioningTemplate>
{
    ...
    public string Kind { get; set; } = "ProvisioningTemplateList";
...
public partial class V1beta2ProvisioningTemplateSpecForProviderProvisioningRoleArnRefPolicy
{
    ...
    public V1beta2ProvisioningTemplateSpecForProviderProvisioningRoleArnRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta2ProvisioningTemplateSpecForProviderProvisioningRoleArnRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta2ProvisioningTemplateSpecForProviderProvisioningRoleArnRef
{
    ...
    public V1beta2ProvisioningTemplateSpecForProviderProvisioningRoleArnRefPolicy? Policy { get; set; }
}
...
public partial class V1beta2ProvisioningTemplateSpecForProviderProvisioningRoleArnSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta2ProvisioningTemplateSpecForProviderProvisioningRoleArnSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta2ProvisioningTemplateSpecForProviderProvisioningRoleArnSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta2ProvisioningTemplateSpecForProvider
{
    ...
    public V1beta2ProvisioningTemplateSpecForProviderPreProvisioningHook? PreProvisioningHook { get; set; }
    ...
    public V1beta2ProvisioningTemplateSpecForProviderProvisioningRoleArnRef? ProvisioningRoleArnRef { get; set; }

    /// <summary>Selector for a Role in iam to populate provisioningRoleArn.</summary>
    [JsonPropertyName("provisioningRoleArnSelector")]
    public V1beta2ProvisioningTemplateSpecForProviderProvisioningRoleArnSelector? ProvisioningRoleArnSelector { get; set; }
...
public partial class V1beta2ProvisioningTemplateSpecInitProviderProvisioningRoleArnRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta2ProvisioningTemplateSpecInitProviderProvisioningRoleArnRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta2ProvisioningTemplateSpecInitProviderProvisioningRoleArnRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta2ProvisioningTemplateSpecInitProviderProvisioningRoleArnRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta2ProvisioningTemplateSpecInitProviderProvisioningRoleArnRefPolicy? Policy { get; set; }
}
...
public partial class V1beta2ProvisioningTemplateSpecInitProviderProvisioningRoleArnSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta2ProvisioningTemplateSpecInitProviderProvisioningRoleArnSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta2ProvisioningTemplateSpecInitProviderProvisioningRoleArnSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta2ProvisioningTemplateSpecInitProviderProvisioningRoleArnSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta2ProvisioningTemplateSpecInitProviderProvisioningRoleArnSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta2ProvisioningTemplateSpecInitProvider
{
    ...
    /// <summary>Creates a pre-provisioning hook template. Details below.</summary>
    [JsonPropertyName("preProvisioningHook")]
    public V1beta2ProvisioningTemplateSpecInitProviderPreProvisioningHook? PreProvisioningHook { get; set; }
    ...
    /// <summary>Reference to a Role in iam to populate provisioningRoleArn.</summary>
    [JsonPropertyName("provisioningRoleArnRef")]
    public V1beta2ProvisioningTemplateSpecInitProviderProvisioningRoleArnRef? ProvisioningRoleArnRef { get; set; }

    /// <summary>Selector for a Role in iam to populate provisioningRoleArn.</summary>
    [JsonPropertyName("provisioningRoleArnSelector")]
    public V1beta2ProvisioningTemplateSpecInitProviderProvisioningRoleArnSelector? ProvisioningRoleArnSelector { get; set; }
...
public partial class V1beta2ProvisioningTemplateSpecProviderConfigRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta2ProvisioningTemplateSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta2ProvisioningTemplateSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta2ProvisioningTemplateSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta2ProvisioningTemplateSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1beta2ProvisioningTemplateSpec
{
    ...
    public V1beta2ProvisioningTemplateSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta2ProvisioningTemplateSpecForProvider ForProvider { get; set; }
    ...
    public V1beta2ProvisioningTemplateSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta2ProvisioningTemplateSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta2ProvisioningTemplateSpecProviderConfigRef? ProviderConfigRef { get; set; }
    ...
    public V1beta2ProvisioningTemplateSpecWriteConnectionSecretToRef? WriteConnectionSecretToRef { get; set; }
}
...
public partial class V1beta2ProvisioningTemplateStatusAtProvider
{
    ...
    /// <summary>Creates a pre-provisioning hook template. Details below.</summary>
    [JsonPropertyName("preProvisioningHook")]
    public V1beta2ProvisioningTemplateStatusAtProviderPreProvisioningHook? PreProvisioningHook { get; set; }
...
public partial class V1beta2ProvisioningTemplateStatus
{
    ...
    public V1beta2ProvisioningTemplateStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta2ProvisioningTemplateStatusConditions>? Conditions { get; set; }
...
public partial class V1beta2ProvisioningTemplate : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta2ProvisioningTemplateSpec>, IStatus<V1beta2ProvisioningTemplateStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ProvisioningTemplate";
    ...
    public required V1beta2ProvisioningTemplateSpec Spec { get; set; }

    /// <summary>ProvisioningTemplateStatus defines the observed state of ProvisioningTemplate.</summary>
    [JsonPropertyName("status")]
    public V1beta2ProvisioningTemplateStatus? Status { get; set; }
}