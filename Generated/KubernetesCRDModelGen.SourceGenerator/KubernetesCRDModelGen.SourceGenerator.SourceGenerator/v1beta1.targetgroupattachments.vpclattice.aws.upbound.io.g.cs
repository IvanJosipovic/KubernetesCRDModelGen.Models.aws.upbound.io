...
public partial class V1beta1TargetGroupAttachmentList : IKubernetesObject<V1ListMeta>, IItems<V1beta1TargetGroupAttachment>
{
    ...
    public const string KubeKind = "TargetGroupAttachmentList";
    public const string KubeGroup = "vpclattice.aws.upbound.io";
    public const string KubePluralName = "targetgroupattachments";
    ...
    public string Kind { get; set; } = "TargetGroupAttachmentList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1TargetGroupAttachment objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1TargetGroupAttachment> Items { get; set; }
}
...
public partial class V1beta1TargetGroupAttachmentSpecForProviderTargetGroupIdentifierRefPolicy
{
    ...
    public V1beta1TargetGroupAttachmentSpecForProviderTargetGroupIdentifierRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1TargetGroupAttachmentSpecForProviderTargetGroupIdentifierRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1TargetGroupAttachmentSpecForProviderTargetGroupIdentifierRef
{
    ...
    public V1beta1TargetGroupAttachmentSpecForProviderTargetGroupIdentifierRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1TargetGroupAttachmentSpecForProviderTargetGroupIdentifierSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1TargetGroupAttachmentSpecForProviderTargetGroupIdentifierSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1TargetGroupAttachmentSpecForProviderTargetGroupIdentifierSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1TargetGroupAttachmentSpecForProvider
{
    ...
    public V1beta1TargetGroupAttachmentSpecForProviderTargetGroupIdentifierRef? TargetGroupIdentifierRef { get; set; }
...
public partial class V1beta1TargetGroupAttachmentSpecInitProviderTargetGroupIdentifierRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1TargetGroupAttachmentSpecInitProviderTargetGroupIdentifierRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1TargetGroupAttachmentSpecInitProviderTargetGroupIdentifierRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1TargetGroupAttachmentSpecInitProviderTargetGroupIdentifierRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1TargetGroupAttachmentSpecInitProviderTargetGroupIdentifierRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1TargetGroupAttachmentSpecInitProviderTargetGroupIdentifierSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1TargetGroupAttachmentSpecInitProviderTargetGroupIdentifierSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1TargetGroupAttachmentSpecInitProviderTargetGroupIdentifierSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1TargetGroupAttachmentSpecInitProviderTargetGroupIdentifierSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1TargetGroupAttachmentSpecInitProviderTargetGroupIdentifierSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1TargetGroupAttachmentSpecInitProvider
{
    ...
    /// <summary>Reference to a TargetGroup in vpclattice to populate targetGroupIdentifier.</summary>
    [JsonPropertyName("targetGroupIdentifierRef")]
    public V1beta1TargetGroupAttachmentSpecInitProviderTargetGroupIdentifierRef? TargetGroupIdentifierRef { get; set; }

    /// <summary>Selector for a TargetGroup in vpclattice to populate targetGroupIdentifier.</summary>
    [JsonPropertyName("targetGroupIdentifierSelector")]
    public V1beta1TargetGroupAttachmentSpecInitProviderTargetGroupIdentifierSelector? TargetGroupIdentifierSelector { get; set; }
}
...
public partial class V1beta1TargetGroupAttachmentSpecProviderConfigRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1TargetGroupAttachmentSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1TargetGroupAttachmentSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1TargetGroupAttachmentSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1TargetGroupAttachmentSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1TargetGroupAttachmentSpec
{
    ...
    public V1beta1TargetGroupAttachmentSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta1TargetGroupAttachmentSpecForProvider ForProvider { get; set; }
    ...
    public V1beta1TargetGroupAttachmentSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1TargetGroupAttachmentSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1TargetGroupAttachmentSpecProviderConfigRef? ProviderConfigRef { get; set; }
...
public partial class V1beta1TargetGroupAttachmentStatus
{
    ...
    public V1beta1TargetGroupAttachmentStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1TargetGroupAttachmentStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "TargetGroupAttachment";
    public const string KubeGroup = "vpclattice.aws.upbound.io";
    public const string KubePluralName = "targetgroupattachments";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "TargetGroupAttachment";
    ...
    public required V1beta1TargetGroupAttachmentSpec Spec { get; set; }

    /// <summary>TargetGroupAttachmentStatus defines the observed state of TargetGroupAttachment.</summary>
    [JsonPropertyName("status")]
    public V1beta1TargetGroupAttachmentStatus? Status { get; set; }
}